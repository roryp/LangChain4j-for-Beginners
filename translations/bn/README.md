...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T08:21:38+00:00",
...
**LangChain4j নতুন?** মূল শব্দ এবং ধারণাগুলোর সংজ্ঞার জন্য [Glossary](docs/GLOSSARY.md) দেখুন।
...
[দ্রুত শুরু](00-quick-start/README.md) মডিউল দিয়ে শুরু করুন এবং প্রতিটি মডিউল অনুসরণ করে ধাপে ধাপে দক্ষতা অর্জন করুন। মৌলিক বিষয় বুঝতে সহজ উদাহরণ চেষ্টা করুন, তারপর GPT-5 সহ গভীরভাবে জানার জন্য [পরিচিতি](01-introduction/README.md) মডিউলে যান।
...
> **দ্রষ্টব্য:** এই প্রশিক্ষণে GitHub মডেল এবং Azure OpenAI উভয়ই ব্যবহৃত হয়। [দ্রুত শুরু](00-quick-start/README.md) এবং [MCP](05-mcp/README.md) মডিউলগুলো GitHub মডেল ব্যবহার করে (Azure সাবস্ক্রিপশন প্রয়োজন নেই), আর মডিউল ১-৪ Azure OpenAI GPT-5 ব্যবহার করে।
