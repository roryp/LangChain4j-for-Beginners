...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T10:08:20+00:00",
  "source_file": "README.md",
  "language_code": "bn"
}
-->
<img src="../../translated_images/LangChain4j.90e1d693fcc71b506e9588f734989dd106ebd9f977b7f784941a28b88348f0d6.bn.png" alt="LangChain4j" width="800"/>
...
LangChain4j এবং Azure OpenAI GPT-5 দিয়ে AI অ্যাপ্লিকেশন তৈরি করার একটি কোর্স, বেসিক চ্যাট থেকে AI এজেন্ট পর্যন্ত।
...
5. [টুলস](04-tools/README.md) - AI এজেন্টের সাথে বাহ্যিক টুলস ও API ইন্টিগ্রেট করুন
...
>
> এই রিপোজিটরিতে ৫০+ ভাষার অনুবাদ রয়েছে যা ডাউনলোড সাইজ অনেক বাড়ায়। অনুবাদ ছাড়া ক্লোন করতে sparse checkout ব্যবহার করুন:
> ```bash
...
[দ্রুত শুরু](00-quick-start/README.md) মডিউল দিয়ে শুরু করুন এবং প্রতিটি মডিউল অতিক্রম করে ধাপে ধাপে দক্ষতা অর্জন করুন। মৌলিক বিষয় বুঝতে বেসিক উদাহরণ চেষ্টা করুন, তারপর GPT-5 সহ গভীরভাবে জানার জন্য [পরিচিতি](01-introduction/README.md) মডিউলে যান।
...
> **দ্রষ্টব্য:** এই প্রশিক্ষণে GitHub Models এবং Azure OpenAI উভয়ই ব্যবহার করা হয়। [দ্রুত শুরু](00-quick-start/README.md) এবং [MCP](05-mcp/README.md) মডিউলগুলো GitHub Models ব্যবহার করে (Azure সাবস্ক্রিপশন প্রয়োজন নেই), আর মডিউল ১-৪ Azure OpenAI GPT-5 ব্যবহার করে।


## GitHub Copilot দিয়ে শেখা

দ্রুত কোডিং শুরু করতে, এই প্রজেক্টটি GitHub Codespace বা আপনার লোকাল IDE তে devcontainer সহ খুলুন। এই কোর্সে ব্যবহৃত devcontainer GitHub Copilot সহ AI পেয়ার প্রোগ্রামিং এর জন্য প্রি-কনফিগার্ড।

প্রতিটি কোড উদাহরণে GitHub Copilot কে জিজ্ঞাসা করার জন্য প্রস্তাবিত প্রশ্ন রয়েছে যা আপনার বোঝাপড়া গভীর করবে। 💡/🤖 প্রম্পটগুলো দেখুন:

- **Java ফাইল হেডার** - প্রতিটি উদাহরণের জন্য নির্দিষ্ট প্রশ্ন
...
যদি আপনার পণ্য প্রতিক্রিয়া বা ত্রুটি থাকে, নির্মাণের সময় দেখুন:
