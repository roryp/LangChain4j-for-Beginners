...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-18T09:39:47+00:00",
...
LangChain4j এবং Azure OpenAI GPT-5 দিয়ে AI অ্যাপ্লিকেশন তৈরি করার একটি কোর্স, মৌলিক চ্যাট থেকে AI এজেন্ট পর্যন্ত।
...
5. [টুলস](04-tools/README.md) - AI এজেন্টের সাথে বাহ্যিক টুলস ও API সংযুক্ত করুন
...
[দ্রুত শুরু](00-quick-start/README.md) মডিউল দিয়ে শুরু করুন এবং প্রতিটি মডিউল অতিক্রম করে ধাপে ধাপে দক্ষতা অর্জন করুন। মৌলিক বিষয় বুঝতে সহজ উদাহরণ চেষ্টা করুন, তারপর GPT-5 সহ গভীরভাবে জানার জন্য [পরিচিতি](01-introduction/README.md) মডিউলে যান।
...
> **দ্রষ্টব্য:** এই প্রশিক্ষণে GitHub Models এবং Azure OpenAI উভয়ই ব্যবহৃত হয়। [দ্রুত শুরু](00-quick-start/README.md) এবং [MCP](05-mcp/README.md) মডিউলগুলো GitHub Models ব্যবহার করে (Azure সাবস্ক্রিপশন প্রয়োজন নেই), আর মডিউল ১-৪ Azure OpenAI GPT-5 ব্যবহার করে।


## GitHub Copilot দিয়ে শেখা

দ্রুত কোডিং শুরু করতে, এই প্রকল্পটি GitHub Codespace বা আপনার স্থানীয় IDE তে devcontainer সহ খুলুন। এই কোর্সে ব্যবহৃত devcontainer GitHub Copilot সহ AI যুগ্ম প্রোগ্রামিংয়ের জন্য পূর্বনির্ধারিত।
