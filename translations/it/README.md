...
> **Nota:** Questa formazione utilizza sia i Modelli GitHub che Azure OpenAI. Il modulo [Avvio Rapido](00-quick-start/README.md) usa i Modelli GitHub (non è richiesta sottoscrizione Azure), mentre i moduli 1-5 utilizzano Azure OpenAI.


## Apprendimento con GitHub Copilot

Per iniziare rapidamente a programmare, apri questo progetto in un GitHub Codespace o nel tuo IDE locale con il devcontainer fornito. Il devcontainer usato in questo corso viene preconfigurato con GitHub Copilot per la programmazione AI in coppia.
...
Questo documento è stato tradotto utilizzando il servizio di traduzione automatica [Co-op Translator](https://github.com/Azure/co-op-translator). Pur impegnandoci per la massima accuratezza, si prega di considerare che le traduzioni automatiche possono contenere errori o inesattezze. Il documento originale nella lingua nativa deve essere considerato la fonte autorevole. Per informazioni critiche, si raccomanda una traduzione professionale effettuata da un esperto umano. Non siamo responsabili per eventuali incomprensioni o interpretazioni errate derivanti dall'uso di questa traduzione.
