...
Per iniziare rapidamente a programmare, apri questo progetto in un GitHub Codespace o nel tuo IDE locale con il devcontainer fornito. Il devcontainer usato in questo corso è preconfigurato con GitHub Copilot per la programmazione in coppia con l'IA.
...
**Come usarlo:** Apri qualsiasi file di codice e poni a Copilot le domande suggerite. Ha il contesto completo del codebase e può spiegare, estendere e suggerire alternative.

Vuoi saperne di più? Dai un'occhiata a [Copilot per la programmazione in coppia con l'IA](https://aka.ms/GitHubCopilotAI).
