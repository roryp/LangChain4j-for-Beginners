...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T23:06:04+00:00",
  "source_file": "README.md",
  "language_code": "it"
}
-->
<img src="../../translated_images/it/LangChain4j.90e1d693fcc71b50.png" alt="LangChain4j" width="800"/>
...
Un corso per creare applicazioni AI con LangChain4j e Azure OpenAI GPT-5, dalla chat di base agli agenti AI.

**Nuovo a LangChain4j?** Dai un'occhiata al [Glossario](docs/GLOSSARY.md) per le definizioni dei termini e concetti chiave.

## Sommario

1. [Primi Passi](00-quick-start/README.md) - Inizia con LangChain4j
...
6. [MCP (Protocollo del Contesto Modello)](05-mcp/README.md) - Lavora con il Protocollo del Contesto Modello (MCP) e i moduli Agentici
---
...
2. Clicca su **Code** → tab **Codespaces** → **...** → **New with options...**
...
6. Passa direttamente a [Primi Passi](./00-quick-start/README.md) per iniziare!
...
> **Nota:** Questa formazione utilizza sia i modelli GitHub che Azure OpenAI. Il modulo [Primi Passi](00-quick-start/README.md) utilizza i modelli GitHub (non è richiesta una sottoscrizione Azure), mentre i moduli 1-5 usano Azure OpenAI.


## Apprendimento con GitHub Copilot

Per iniziare rapidamente a scrivere codice, apri questo progetto in un GitHub Codespace o nel tuo IDE locale con il devcontainer fornito. Il devcontainer usato in questo corso è pre-configurato con GitHub Copilot per la programmazione in coppia AI.
...
Vuoi saperne di più? Guarda [Copilot per la programmazione in coppia AI](https://aka.ms/GitHubCopilotAI).
...
Se sei bloccato o hai domande su come costruire app AI, unisciti a:
