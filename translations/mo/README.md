...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-18T09:32:02+00:00",
...
完成模組後，探索 [測試指南](docs/TESTING.md) 以實際了解 LangChain4j 的測試概念。

> **注意：** 本訓練同時使用 GitHub 模型與 Azure OpenAI。[快速入門](00-quick-start/README.md) 和 [MCP](05-mcp/README.md) 模組使用 GitHub 模型（無需 Azure 訂閱），而模組 1-4 則使用 Azure OpenAI GPT-5。
...
**使用方法：** 開啟任何程式碼檔案，向 Copilot 詢問建議問題。它擁有完整的程式碼庫上下文，能解釋、擴展並建議替代方案。
