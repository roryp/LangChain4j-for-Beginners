...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T14:42:56+00:00",
...
**חדש ב-LangChain4j?** עיין ב-[מילון](docs/GLOSSARY.md) להגדרות מונחים ומושגים מרכזיים.
...
4. [RAG (יצירה משופרת על ידי אחזור)](03-rag/README.md) - בנה מערכות חכמות מבוססות ידע  
5. [כלים](04-tools/README.md) - שלב כלים חיצוניים ו-APIs עם סוכני AI  
6. [MCP (פרוטוקול הקשר מודל)](05-mcp/README.md) - עבודה עם פרוטוקול הקשר מודל  
---

## מסלול הלמידה

התחל עם מודול [התחלה מהירה](00-quick-start/README.md) והתקדם דרך כל מודול כדי לבנות את הכישורים שלך שלב אחר שלב. תנסה דוגמאות בסיסיות כדי להבין את היסודות לפני המעבר למודול [מבוא](01-introduction/README.md) לצלול לעומק עם GPT-5.
...
> **הערה:** הכשרה זו משתמשת גם במודלים של GitHub וגם ב-Azure OpenAI. מודולי [התחלה מהירה](00-quick-start/README.md) ו-[MCP](05-mcp/README.md) משתמשים במודלים של GitHub (אין צורך במנוי Azure), בעוד שמודולים 1-4 משתמשים ב-Azure OpenAI GPT-5.

## למידה עם GitHub Copilot

כדי להתחיל לתכנת במהירות, פתח את הפרויקט הזה ב-GitHub Codespace או ב-IDE המקומי שלך עם ה-devcontainer המסופק. ה-devcontainer המשמש בקורס זה מגיע מוגדר מראש עם GitHub Copilot לתכנות משותף מבוסס AI.
...
- **קבצי README של מודולים** - שאלות חקר לאחר דוגמאות הקוד  
