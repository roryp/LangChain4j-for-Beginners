...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-06T00:29:59+00:00",
  "source_file": "README.md",
  "language_code": "tl"
}
-->
<img src="../../translated_images/tl/LangChain4j.90e1d693fcc71b50.png" alt="LangChain4j" width="800"/>
...
> Kasama sa repositoryong ito ang mahigit 50 mga pagsasalin ng wika na malaki ang dagdag sa laki ng download. Para mag-clone nang walang mga pagsasalin, gamitin ang sparse checkout:
> ```bash
> git clone --filter=blob:none --sparse https://github.com/microsoft/LangChain4j-for-Beginners.git
> cd LangChain4j-for-Beginners
> git sparse-checkout set --no-cone '/*' '!translations' '!translated_images'
> ```
> Bibigyan ka nito ng lahat ng kailangan mo para kumpletuhin ang kurso nang mas mabilis ang pag-download.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

# LangChain4j para sa mga Baguhan

Isang kurso para sa paggawa ng mga AI application gamit ang LangChain4j at Azure OpenAI GPT-5, mula sa batayang chat hanggang sa AI agents.

**Bago sa LangChain4j?** Tingnan ang [Glossary](docs/GLOSSARY.md) para sa mga depinisyon ng mga mahahalagang termino at konsepto.
...
4. [RAG (Retrieval-Augmented Generation)](03-rag/README.md) - Bumuo ng matatalinong kaalamang pang-sistema
5. [Mga Tool](04-tools/README.md) - Isama ang mga panlabas na tool at simpleng mga katulong
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Gamitin ang Model Context Protocol (MCP) at mga Agentic module
---
...
> **Tandaan:** Ginagamit ng pagsasanay na ito ang parehong GitHub Models at Azure OpenAI. Ginagamit ang [Mabilis na Pagsisimula](00-quick-start/README.md) na module ng GitHub Models (hindi kinakailangan ng Azure subscription), habang ang mga module 1-5 ay gumagamit ng Azure OpenAI.


## Pagkatuto gamit ang GitHub Copilot

Para mabilis na makapagsimula sa pag-cocode, buksan ang proyektong ito sa isang GitHub Codespace o sa iyong lokal na IDE gamit ang ibinigay na devcontainer. Ang devcontainer na ginamit sa kursong ito ay pre-configured na may GitHub Copilot para sa AI na magkasamang programming.

Kasama sa bawat halimbawa ng code ang mga mungkahing tanong na maaari mong itanong sa GitHub Copilot para palalimin ang iyong pang-unawa. Hanapin ang mga 💡/🤖 na prompt sa:

- **Java file headers** - Mga tanong na tiyak para sa bawat halimbawa
- **Mga README ng Module** - Mga prompt sa eksplorasyon pagkatapos ng mga halimbawa ng code
...
Kung may feedback ka tungkol sa produkto o mga error habang gumagawa, bisitahin:
...
**Paunawa**:
Ang dokumentong ito ay isinalin gamit ang serbisyong AI na pagsasalin na [Co-op Translator](https://github.com/Azure/co-op-translator). Bagama't nagsusumikap kami na maging tumpak, paunawa na ang mga awtomatikong pagsasalin ay maaaring maglaman ng mga pagkakamali o di-katiyakan. Ang orihinal na dokumento sa kanyang katutubong wika ang dapat ituring na opisyal na sanggunian. Para sa mahahalagang impormasyon, inirerekomenda ang propesyonal na pagsasaling-tao. Hindi kami mananagot sa anumang hindi pagkakaunawaan o maling interpretasyon na maaaring magmula sa paggamit ng pagsasaling ito.
