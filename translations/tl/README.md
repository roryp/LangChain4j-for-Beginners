...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-16T09:20:14+00:00",
...
> Kasama sa repositoryong ito ang 50+ pagsasalin ng wika na nagpapalaki nang malaki ng laki ng download. Para mag-clone nang walang mga pagsasalin, gamitin ang sparse checkout:
> ```bash
> git clone --filter=blob:none --sparse https://github.com/microsoft/LangChain4j-for-Beginners.git
> cd LangChain4j-for-Beginners
> git sparse-checkout set --no-cone '/*' '!translations' '!translated_images'
> ```
> Binibigyan ka nito ng lahat ng kailangan mo para matapos ang kurso na may mas mabilis na pag-download.
...
2. [Introduksyon](01-introduction/README.md) - Alamin ang mga pundasyon ng LangChain4j
3. [Prompt Engineering](02-prompt-engineering/README.md) - Maging bihasa sa epektibong disenyo ng prompt
4. [RAG (Retrieval-Augmented Generation)](03-rag/README.md) - Bumuo ng matatalinong knowledge-based na mga sistema
5. [Mga Tools](04-tools/README.md) - Isama ang mga panlabas na tool at simpleng mga asistente
...
6. Daliin ang sarili sa [Quick Start](./00-quick-start/README.md) para magsimula!

Pagkatapos matapos ang mga module, tuklasin ang [Testing Guide](docs/TESTING.md) upang makita ang mga konsepto ng pagsubok sa LangChain4j na ginagawa.

> **Tandaan:** Ginagamit ng pagsasanay na ito ang parehong GitHub Models at Azure OpenAI. Ang [Quick Start](00-quick-start/README.md) na module ay gumagamit ng GitHub Models (hindi kailangan ng Azure subscription), samantalang ang mga module 1-5 ay gumagamit ng Azure OpenAI.

## Pag-aaral gamit ang GitHub Copilot

Para mabilis na magsimula sa coding, buksan ang proyektong ito sa GitHub Codespace o ang iyong lokal na IDE gamit ang ibinigay na devcontainer. Ang devcontainer na ginamit sa kursong ito ay naka-pre-configure kasama ang GitHub Copilot para sa AI paired programming.

Bawat halimbawa ng code ay may kasamang mga mungkahing tanong na pwede mong itanong sa GitHub Copilot upang higit pang maintindihan. Hanapin ang mga 💡/🤖 na prompt sa:

- **Java file headers** - Mga tanong na partikular sa bawat halimbawa
- **Module READMEs** - Mga prompt na pang-explorasyon pagkatapos ng mga halimbawa ng code

**Paano gamitin:** Buksan ang kahit anong file ng code at itanong sa Copilot ang mga mungkahing tanong. Mayroon itong kompletong konteksto ng codebase at kaya nitong magpaliwanag, magpalawak, at magmungkahi ng mga alternatibo.
...
**Paalala**:
Ang dokumentong ito ay isinalin gamit ang AI translation service na [Co-op Translator](https://github.com/Azure/co-op-translator). Bagamat aming pinagsisikapan ang katumpakan, pakatandaan na ang mga awtomatikong pagsasalin ay maaaring maglaman ng mga pagkakamali o maling impormasyon. Ang orihinal na dokumento sa wikang pinagmulan nito ang dapat ituring na pangunahing sanggunian. Para sa mahahalagang impormasyon, inirerekomenda ang propesyonal na pagsasaling-tao. Hindi kami mananagot sa anumang hindi pagkakaunawaan o maling interpretasyon na maaaring magmula sa paggamit ng pagsasaling ito.
