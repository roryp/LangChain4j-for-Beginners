...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-16T11:33:11+00:00",
...
> ```
> Toto vám poskytne všetko potrebné na absolvovanie kurzu s podstatne rýchlejším sťahovaním.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

# LangChain4j pre začiatočníkov

Kurz na budovanie AI aplikácií s LangChain4j a Azure OpenAI GPT-5, od základného chatu po AI agentov.
...
3. [Prompt Engineering](02-prompt-engineering/README.md) - Ovládnite efektívne navrhovanie promptov
4. [RAG (Retrieval-Augmented Generation)](03-rag/README.md) - Vytvárajte inteligentné systémy založené na poznatkoch
...
3. Použite prednastavené hodnoty – toto vyberie vývojové prostredie vytvorené pre tento kurz
4. Kliknite na **Create codespace**
5. Počkajte 5-10 minút, kým je prostredie pripravené
6. Prejdite rovno na [Rýchly štart](./00-quick-start/README.md) a začnite!
...
> **Poznámka:** Tento tréning používa modely GitHub aj Azure OpenAI. Modul [Rýchly štart](00-quick-start/README.md) používa GitHub modely (nevyžaduje predplatné Azure), zatiaľ čo moduly 1-5 používajú Azure OpenAI.


## Vzdelávanie s GitHub Copilot

Aby ste mohli rýchlo začať programovať, otvorte tento projekt v GitHub Codespace alebo vo vašom lokálnom IDE s poskytnutým devcontainerom. Devcontainer použitý v tomto kurze je prednastavený s GitHub Copilot pre AI párované programovanie.

Každý príklad kódu obsahuje navrhované otázky, ktoré môžete položiť GitHub Copilot, aby ste prehlbili svoje pochopenie. Hľadajte výzvy 💡/🤖 v:

- **Hlavičkách Java súborov** - Otázky špecifické pre každý príklad
- **README modulov** - Výzvy na skúmanie po príkladoch kódu

**Ako používať:** Otvorte ľubovoľný súbor s kódom a položte Copilotovi navrhované otázky. Má úplný kontext kódu a vie vysvetliť, rozšíriť a navrhnúť alternatívy.
...
Ak sa zaseknete alebo máte nejaké otázky ohľadom tvorby AI aplikácií, pripojte sa:

[![Azure AI Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

Ak máte spätnú väzbu k produktu alebo sa vyskytnú chyby počas tvorby, navštívte:

[![Azure AI Foundry Developer Forum](https://img.shields.io/badge/GitHub-Azure_AI_Foundry_Developer_Forum-blue?style=for-the-badge&logo=github&color=000000&logoColor=fff)](https://aka.ms/foundry/forum)

## Licencia

MIT licencia - Viac informácií nájdete v súbore [LICENSE](../../LICENSE).

---

<!-- CO-OP TRANSLATOR DISCLAIMER START -->
**Vyhlásenie o zodpovednosti**:
Tento dokument bol preložený pomocou AI prekladateľskej služby [Co-op Translator](https://github.com/Azure/co-op-translator). Aj keď sa snažíme o presnosť, prosím, berte na vedomie, že automatické preklady môžu obsahovať chyby alebo nepresnosti. Pôvodný dokument v jeho natívnom jazyku by mal byť považovaný za autoritatívny zdroj. Pre kritické informácie sa odporúča odborný ľudský preklad. Nie sme zodpovední za akékoľvek nepochopenia alebo nesprávne interpretácie vyplývajúce z použitia tohto prekladu.
