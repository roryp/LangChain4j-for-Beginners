...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-06T00:54:56+00:00",
  "source_file": "README.md",
  "language_code": "sk"
}
-->
<img src="../../translated_images/sk/LangChain4j.90e1d693fcc71b50.png" alt="LangChain4j" width="800"/>
...
3. Použite prednastavené hodnoty – vyberie sa vývojové kontajner vytvorené pre tento kurz
...
Po dokončení modulov preskúmajte [Príručku testovania](docs/TESTING.md) a uvidíte koncepty testovania LangChain4j v praxi.

> **Poznámka:** Toto školenie používa modely GitHub i Azure OpenAI. Modul [Rýchly štart](00-quick-start/README.md) používa modely GitHub (nevyžaduje sa predplatné Azure), zatiaľ čo moduly 1-5 používajú Azure OpenAI.

## Učenie s GitHub Copilot

Pre rýchly štart programovania otvorte tento projekt v GitHub Codespace alebo vo vašom lokálnom IDE s poskytnutým devcontainerom. Devcontainer použitý v tomto kurze je predkonfigurovaný s GitHub Copilot pre AI párované programovanie.

Každý príklad kódu obsahuje navrhované otázky, ktoré môžete položiť GitHub Copilot na prehĺbenie vášho porozumenia. Hľadajte výzvy 💡/🤖 v:

- **Hlavičkách Java súborov** - Otázky špecifické pre každý príklad
- **README modulov** - Preskúmavacie výzvy po príkladoch

**Ako používať:** Otvorte akýkoľvek súbor s kódom a položte Copilotu navrhované otázky. Má plný kontext kódu a vie vysvetľovať, rozširovať a navrhovať alternatívy.
...
Ak máte spätnú väzbu k produktu alebo nájdete chyby počas vývoja, navštívte:
...
Licencia MIT - Viac informácií nájdete v súbore [LICENSE](../../LICENSE).
