...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-13T12:44:53+00:00",
...
Začnite s modulom [Rýchly štart](00-quick-start/README.md) a postupujte cez každý modul, aby ste si krok za krokom vybudovali zručnosti. Vyskúšate si základné príklady na pochopenie základov predtým, než prejdete do modulu [Úvod](01-introduction/README.md) pre hlbšie štúdium s GPT-5.
...
Ak chcete rýchlo začať kódovať, otvorte tento projekt v GitHub Codespace alebo vo vašom lokálnom IDE s poskytnutým devcontainerom. Devcontainer použitý v tomto kurze je predkonfigurovaný s GitHub Copilot pre AI párované programovanie.
