...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T21:35:56+00:00",
...
[العربية](./README.md) | [البنغالية](../bn/README.md) | [البلغارية](../bg/README.md) | [البرمية (ميانمار)](../my/README.md) | [الصينية (المبسطة)](../zh/README.md) | [الصينية (التقليدية، هونغ كونغ)](../hk/README.md) | [الصينية (التقليدية، ماكاو)](../mo/README.md) | [الصينية (التقليدية، تايوان)](../tw/README.md) | [الكرواتية](../hr/README.md) | [التشيكية](../cs/README.md) | [الدانمركية](../da/README.md) | [الهولندية](../nl/README.md) | [الإستونية](../et/README.md) | [الفنلندية](../fi/README.md) | [الفرنسية](../fr/README.md) | [الألمانية](../de/README.md) | [اليونانية](../el/README.md) | [العبرية](../he/README.md) | [الهندية](../hi/README.md) | [الهنغارية](../hu/README.md) | [الإندونيسية](../id/README.md) | [الإيطالية](../it/README.md) | [اليابانية](../ja/README.md) | [الكانادا](../kn/README.md) | [الكورية](../ko/README.md) | [الليتوانية](../lt/README.md) | [الماليزية](../ms/README.md) | [الملالامية](../ml/README.md) | [الماراثية](../mr/README.md) | [النيبالية](../ne/README.md) | [النيجيرية بيدجن](../pcm/README.md) | [النرويجية](../no/README.md) | [الفارسية (اللغة الفارسية)](../fa/README.md) | [البولندية](../pl/README.md) | [البرتغالية (البرازيل)](../br/README.md) | [البرتغالية (البرتغال)](../pt/README.md) | [البنجابية (غورموخي)](../pa/README.md) | [الرومانية](../ro/README.md) | [الروسية](../ru/README.md) | [الصربية (السيريلية)](../sr/README.md) | [السلوفاكية](../sk/README.md) | [السلوفينية](../sl/README.md) | [الإسبانية](../es/README.md) | [السواحيلية](../sw/README.md) | [السويدية](../sv/README.md) | [التاغالوغ (الفلبيونية)](../tl/README.md) | [التاميلية](../ta/README.md) | [التيلوجو](../te/README.md) | [التايلاندية](../th/README.md) | [التركية](../tr/README.md) | [الأوكرانية](../uk/README.md) | [الأردية](../ur/README.md) | [الفيتنامية](../vi/README.md)

> **تفضل النسخ محليًا؟**

> يتضمن هذا المستودع أكثر من 50 ترجمة للغات مما يزيد بشكل كبير من حجم التنزيل. للنسخ بدون الترجمات، استخدم الفحص الجزئي:
> ```bash
> git clone --filter=blob:none --sparse https://github.com/microsoft/LangChain4j-for-Beginners.git
> cd LangChain4j-for-Beginners
> git sparse-checkout set --no-cone '/*' '!translations' '!translated_images'
> ```
> هذا يوفر لك كل ما تحتاجه لإكمال الدورة بتحميل أسرع بكثير.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

# LangChain4j للمبتدئين

دورة لبناء تطبيقات الذكاء الاصطناعي مع LangChain4j و Azure OpenAI GPT-5، من الدردشة الأساسية إلى وكلاء الذكاء الاصطناعي.

**جديد على LangChain4j؟** تصفح [مسرد المصطلحات](docs/GLOSSARY.md) لتعريفات المصطلحات والمفاهيم الرئيسية.

## جدول المحتويات

1. [البدء السريع](00-quick-start/README.md) - ابدأ مع LangChain4j
2. [مقدمة](01-introduction/README.md) - تعرّف على أساسيات LangChain4j
3. [هندسة الموجهات](02-prompt-engineering/README.md) - اتقن تصميم الموجهات الفعالة
4. [RAG (توليد معزز بالاستخراج)](03-rag/README.md) - بناء أنظمة ذكية قائمة على المعرفة
5. [الأدوات](04-tools/README.md) - دمج الأدوات الخارجية والمساعدين البسيطين
6. [MCP (بروتوكول سياق النموذج)](05-mcp/README.md) - العمل مع بروتوكول سياق النموذج ووحدات الوكلاء
---
...
1. فرّع هذا المستودع إلى حساب GitHub الخاص بك
2. انقر على **كود** → علامة تبويب **مساحات الكود** → **...** → **جديد مع خيارات...**
3. استخدم الإعدادات الافتراضية – هذا سيختار حاوية التطوير المُنشأة لهذه الدورة
4. انقر على **إنشاء مساحة الكود**
5. انتظر 5-10 دقائق حتى يكون البيئة جاهزة
6. ابدأ مباشرةً من [البدء السريع](./00-quick-start/README.md) للانطلاق!
...
> **ملاحظة:** هذا التدريب يستخدم كل من نماذج GitHub و Azure OpenAI. وحدة [البدء السريع](00-quick-start/README.md) تستخدم نماذج GitHub (لا يتطلب اشتراك Azure)، بينما الوحدات 1-5 تستخدم Azure OpenAI.


## التعلم مع GitHub Copilot

للبدء السريع في البرمجة، افتح هذا المشروع في مساحة كود GitHub أو بيئة التطوير المحلية الخاصة بك مع devcontainer المقدم. devcontainer المستخدم في هذه الدورة مُهيأ مسبقًا مع GitHub Copilot لبرمجة الذكاء الاصطناعي بتعاون ثنائي.

كل مثال كود يتضمن أسئلة مقترحة يمكنك طرحها على GitHub Copilot لتعميق فهمك. ابحث عن إرشادات 💡/🤖 في:

- **رؤوس ملفات جافا** - أسئلة خاصة بكل مثال
- **ملفات README للوحدات** - إرشادات استكشافية بعد أمثلة الكود

**كيفية الاستخدام:** افتح أي ملف كود واطرح على Copilot الأسئلة المقترحة. لديه السياق الكامل لقاعدة الكود ويمكنه الشرح، التوسيع، واقتراح البدائل.

هل تريد تعلم المزيد؟ تصفح [Copilot للبرمجة الثنائية مع الذكاء الاصطناعي](https://aka.ms/GitHubCopilotAI).
...
**إخلاء مسؤولية**:
تمت ترجمة هذا المستند باستخدام خدمة الترجمة الآلية [Co-op Translator](https://github.com/Azure/co-op-translator). بينما نسعى لتحقيق الدقة، يرجى العلم أن الترجمات الآلية قد تحتوي على أخطاء أو عدم دقة. يجب اعتبار المستند الأصلي بلغته الأصلية المصدر الرسمي والمعتمد. للمعلومات الحرجة، يُنصح بالترجمة الاحترافية البشرية. لسنا مسؤولين عن أي سوء فهم أو تحريف ناجم عن استخدام هذه الترجمة.
