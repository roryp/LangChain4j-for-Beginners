...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-30T19:08:55+00:00",
...
5. [Outils](04-tools/README.md) - Intégrez des outils externes et des assistants simples
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Travaillez avec le Model Context Protocol (MCP) et les modules agentiques
---
...
>
> Ce dépôt inclut plus de 50 traductions, ce qui augmente significativement la taille de téléchargement. Pour cloner sans les traductions, utilisez le sparse checkout:
> ```bash
...
> **Remarque :** Cette formation utilise à la fois les modèles GitHub et Azure OpenAI. Les modules [Démarrage rapide](00-quick-start/README.md) et [MCP](05-mcp/README.md) utilisent les modèles GitHub (aucun abonnement Azure requis), tandis que les modules 1 à 4 utilisent Azure OpenAI GPT-5.


## Apprentissage avec GitHub Copilot

Pour commencer rapidement à coder, ouvrez ce projet dans un GitHub Codespace ou votre IDE local avec le devcontainer fourni. Le devcontainer utilisé dans ce cours est préconfiguré avec GitHub Copilot pour la programmation en binôme assistée par l'IA.
...
**Comment l'utiliser :** Ouvrez n'importe quel fichier de code et posez à Copilot les questions suggérées. Il a le contexte complet du code et peut expliquer, étendre et proposer des alternatives.

Envie d'en savoir plus ? Consultez [Copilot for AI Paired Programming](https://aka.ms/GitHubCopilotAI).
...
Si vous avez des commentaires sur le produit ou rencontrez des erreurs pendant le développement, rendez-vous sur :
