...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T23:30:26+00:00",
  "source_file": "README.md",
  "language_code": "th"
}
-->
<img src="../../translated_images/th/LangChain4j.90e1d693fcc71b50.png" alt="LangChain4j" width="800"/>
...
[อาหรับ](../ar/README.md) | [เบงกาลี](../bn/README.md) | [บัลแกเรีย](../bg/README.md) | [ภาษาพม่า (เมียนมา)](../my/README.md) | [ภาษาจีน (ตัวย่อ)](../zh/README.md) | [ภาษาจีน (ตัวเต็ม, ฮ่องกง)](../hk/README.md) | [ภาษาจีน (ตัวเต็ม, มาเก๊า)](../mo/README.md) | [ภาษาจีน (ตัวเต็ม, ไต้หวัน)](../tw/README.md) | [โครเอเชีย](../hr/README.md) | [เช็ก](../cs/README.md) | [เดนมาร์ก](../da/README.md) | [ดัตช์](../nl/README.md) | [เอสโตเนีย](../et/README.md) | [ฟินแลนด์](../fi/README.md) | [ฝรั่งเศส](../fr/README.md) | [เยอรมัน](../de/README.md) | [กรีก](../el/README.md) | [ฮิบรู](../he/README.md) | [ฮินดี](../hi/README.md) | [ฮังการี](../hu/README.md) | [อินโดนีเซีย](../id/README.md) | [อิตาลี](../it/README.md) | [ญี่ปุ่น](../ja/README.md) | [กันนาดา](../kn/README.md) | [เกาหลี](../ko/README.md) | [ลิทัวเนีย](../lt/README.md) | [มาเลย์](../ms/README.md) | [มาลายาลัม](../ml/README.md) | [มราฐี](../mr/README.md) | [เนปาล](../ne/README.md) | [นิเจอร์เลียน พิดจิน](../pcm/README.md) | [นอร์เวย์](../no/README.md) | [เปอร์เซีย (ฟาร์ซี)](../fa/README.md) | [โปแลนด์](../pl/README.md) | [โปรตุเกส (บราซิล)](../br/README.md) | [โปรตุเกส (โปรตุเกส)](../pt/README.md) | [ปัญจาบี (กุรมุขี)](../pa/README.md) | [โรมาเนีย](../ro/README.md) | [รัสเซีย](../ru/README.md) | [เซอร์เบีย (ซีริลลิก)](../sr/README.md) | [สโลวัก](../sk/README.md) | [สโลวีเนีย](../sl/README.md) | [สเปน](../es/README.md) | [สวาฮีลี](../sw/README.md) | [สวีเดน](../sv/README.md) | [ตากาล็อก (ฟิลิปปินส์)](../tl/README.md) | [ทมิฬ](../ta/README.md) | [เตลูกู](../te/README.md) | [ไทย](./README.md) | [ตุรกี](../tr/README.md) | [ยูเครน](../uk/README.md) | [อูรดู](../ur/README.md) | [เวียดนาม](../vi/README.md)

> **ต้องการโคลนไว้ใช้ในเครื่องไหม?**

> ที่เก็บนี้รวมการแปลภาษา 50+ ภาษา ซึ่งเพิ่มขนาดการดาวน์โหลดอย่างมาก หากต้องการโคลนโดยไม่รวมการแปล ให้ใช้ sparse checkout:
> ```bash
...
หลักสูตรสำหรับการสร้างแอป AI ด้วย LangChain4j และ Azure OpenAI GPT-5 ตั้งแต่แชทพื้นฐานจนถึงผู้ช่วย AI

**ใหม่กับ LangChain4j?** ดูที่ [คำศัพท์](docs/GLOSSARY.md) สำหรับคำจำกัดความของคำและแนวคิดสำคัญ
...
4. [RAG (การสร้างด้วยการค้นคืน)](03-rag/README.md) - สร้างระบบความรู้ที่ชาญฉลาด
5. [เครื่องมือ](04-tools/README.md) - รวมเครื่องมือภายนอกและผู้ช่วยง่ายๆ
6. [MCP (โปรโตคอลบริบทแบบจำลอง)](05-mcp/README.md) - ทำงานกับ MCP และโมดูล Agentic
---
...
2. คลิก **Code** → แท็บ **Codespaces** → **...** → **ใหม่พร้อมตัวเลือก...**
3. ใช้ค่าเริ่มต้น – จะเลือก Development container ที่สร้างขึ้นสำหรับหลักสูตรนี้
4. คลิก **สร้าง codespace**
5. รอ 5-10 นาทีสำหรับสิ่งแวดล้อมพร้อมใช้งาน
6. ไปที่ [เริ่มต้นอย่างรวดเร็ว](./00-quick-start/README.md) เพื่อเริ่มต้นเลย!
...
หลังจากเรียนจบโมดูลต่างๆ แล้ว ให้สำรวจ [คู่มือการทดสอบ](docs/TESTING.md) เพื่อดูแนวคิดการทดสอบ LangChain4j ในการปฏิบัติ

> **หมายเหตุ:** การฝึกอบรมนี้ใช้ทั้ง GitHub Models และ Azure OpenAI โมดูล [เริ่มต้นอย่างรวดเร็ว](00-quick-start/README.md) ใช้ GitHub Models (ไม่ต้องสมัคร Azure) ส่วนโมดูล 1-5 ใช้ Azure OpenAI


## การเรียนรู้กับ GitHub Copilot

เพื่อเริ่มเขียนโค้ดอย่างรวดเร็ว ให้เปิดโปรเจกต์นี้ใน GitHub Codespace หรือ IDE ในเครื่องพร้อม devcontainer ที่เตรียมไว้ Devcontainer ที่ใช้ในหลักสูตรนี้มีการตั้งค่า GitHub Copilot สำหรับการเขียนโปรแกรมคู่ AI

ตัวอย่างโค้ดแต่ละชิ้นจะมีคำถามแนะนำที่คุณสามารถถาม GitHub Copilot เพื่อเพิ่มความเข้าใจ ค้นหาได้จากสัญลักษณ์ 💡/🤖 ใน:

- **ส่วนหัวไฟล์ Java** - คำถามเฉพาะสำหรับตัวอย่างแต่ละตัว
- **ไฟล์ README ของโมดูล** - คำถามสำรวจหลังตัวอย่างโค้ด

**วิธีใช้:** เปิดไฟล์โค้ดใดก็ได้และถามคำถามที่แนะนำให้ Copilot มันมีบริบทโค้ดทั้งหมดและสามารถอธิบาย ขยายความ และแนะนำทางเลือกได้

ต้องการเรียนรู้เพิ่มเติมไหม? ดูที่ [Copilot สำหรับการเขียนโปรแกรมคู่ AI](https://aka.ms/GitHubCopilotAI).
...
[![เว็บเดฟ สำหรับผู้เริ่มต้น](https://img.shields.io/badge/Web%20Dev%20for%20Beginners-EC4899?style=for-the-badge&labelColor=E5E7EB&color=EC4899)](https://aka.ms/webdev-beginners?WT.mc_id=academic-105485-koreyst)
...
ถ้าคุณติดขัดหรืมีคำถามเกี่ยวกับการสร้างแอป AI เข้าร่วมได้ที่:

[![Azure AI Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

ถ้าคุณมีคำติชมผลิตภัณฑ์หรือพบข้อผิดพลาดในขณะสร้าง สามารถเยี่ยมชมได้ที่:
