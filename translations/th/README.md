...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-18T09:54:46+00:00",
...
หลักสูตรสำหรับการสร้างแอปพลิเคชัน AI ด้วย LangChain4j และ Azure OpenAI GPT-5 ตั้งแต่แชทพื้นฐานไปจนถึงเอเจนต์ AI
...
6. [MCP (Model Context Protocol)](05-mcp/README.md) - ทำงานกับโปรโตคอลบริบทของโมเดล
---
...
3. ใช้ค่าปริยาย – จะเลือก Development container ที่สร้างไว้สำหรับหลักสูตรนี้
...
เพื่อเริ่มเขียนโค้ดอย่างรวดเร็ว ให้เปิดโปรเจกต์นี้ใน GitHub Codespace หรือ IDE ในเครื่องของคุณโดยใช้ devcontainer ที่จัดเตรียมไว้ Devcontainer ที่ใช้ในหลักสูตรนี้ได้ตั้งค่า GitHub Copilot สำหรับการเขียนโปรแกรมคู่กับ AI ไว้ล่วงหน้าแล้ว
