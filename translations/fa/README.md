...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T14:13:43+00:00",
...
- **README ماژول‌ها** - پیشنهادات کاوش پس از مثال‌های کد  

**نحوه استفاده:** هر فایل کدی را باز کنید و سوالات پیشنهادی را از Copilot بپرسید. او به طور کامل به کد دسترسی دارد و می‌تواند توضیح دهد، گسترش دهد و جایگزین‌هایی پیشنهاد کند.
