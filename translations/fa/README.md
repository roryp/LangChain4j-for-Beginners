...
> ```
> این به شما همه چیز را می‌دهد تا دوره را با دانلود بسیار سریع‌تر کامل کنید.
...
**جدید در LangChain4j؟** به [لغت‌نامه](docs/GLOSSARY.md) برای تعاریف کلید واژه‌ها و مفاهیم مراجعه کنید.

## فهرست مطالب

1. [شروع سریع](00-quick-start/README.md) - شروع با LangChain4j
2. [مقدمه](01-introduction/README.md) - یادگیری اصول پایه LangChain4j
3. [مهندسی پرامپت](02-prompt-engineering/README.md) - تسلط بر طراحی پرامپت موثر
4. [RAG (تولید تکمیل شده با بازیابی)](03-rag/README.md) - ساخت سیستم‌های دانش‌بنیان هوشمند
...
5. ۵ تا ۱۰ دقیقه صبر کنید تا محیط آماده شود
6. مستقیماً به [شروع سریع](./00-quick-start/README.md) بروید و شروع کنید!

پس از اتمام ماژول‌ها، راهنمای [آزمایش](docs/TESTING.md) را برای دیدن مفاهیم آزمایش LangChain4j در عمل کاوش کنید.

> **توجه:** این آموزش از هر دو مدل GitHub و Azure OpenAI استفاده می‌کند. ماژول [شروع سریع](00-quick-start/README.md) از مدل GitHub استفاده می‌کند (نیازی به اشتراک Azure نیست)، در حالی که ماژول‌های ۱ تا ۵ از Azure OpenAI بهره می‌برند.

## یادگیری با GitHub Copilot

برای شروع سریع برنامه‌نویسی، این پروژه را در GitHub Codespace یا IDE محلی خود با devcontainer ارائه شده باز کنید. devcontainer استفاده شده در این دوره از قبل با GitHub Copilot برای برنامه‌نویسی جفت AI پیکربندی شده است.
...
- **سرفصل فایل‌های جاوا** - سوالات مختص هر مثال
- **READMEهای ماژول** - پرسش‌های اکتشافی بعد از نمونه کدها

**نحوه استفاده:** هر فایل کد را باز کنید و سوالات پیشنهادی را از Copilot بپرسید. او کامل به بافت کد دسترسی دارد و می‌تواند توضیح دهد، گسترش دهد و جایگزین‌ها را پیشنهاد کند.

می‌خواهید بیشتر بدانید؟ به [Copilot برای برنامه‌نویسی جفت AI](https://aka.ms/GitHubCopilotAI) مراجعه کنید.
...
اگر بازخوردی درباره محصول دارید یا هنگام ساخت با خطا مواجه شدید، مراجعه کنید به:
...
**توجه مهم**:
این سند با استفاده از سرویس ترجمه هوش مصنوعی [Co-op Translator](https://github.com/Azure/co-op-translator) ترجمه شده است. با اینکه ما در تلاش برای دقت هستیم، لطفاً توجه داشته باشید که ترجمه‌های خودکار ممکن است حاوی اشتباهات یا نادرستی‌هایی باشند. سند اصلی به زبان مادری خود، باید به عنوان منبع معتبر در نظر گرفته شود. برای اطلاعات حیاتی، توصیه می‌شود از ترجمه حرفه‌ای انسانی استفاده شود. ما مسئول هیچ گونه سوء تفاهم یا برداشت نادرستی که از استفاده از این ترجمه به وجود آید نیستیم.
