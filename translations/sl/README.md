...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-23T11:03:11+00:00",
...
**Nov v LangChain4j?** Oglejte si [Slovar izrazov](docs/GLOSSARY.md) za definicije ključnih terminov in pojmov.
...
4. [RAG (Retrieval-Augmented Generation)](03-rag/README.md) - Zgradite inteligentne sisteme, ki temeljijo na znanju
5. [Orodja](04-tools/README.md) - Integrirajte zunanja orodja in API-je z AI agenti
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Delo s protokolom Model Context
---
...
2. Kliknite **Code** → **Codespaces** zavihek → **...** → **New with options...**
...
6. Pojdite neposredno na [Hitri začetek](./00-quick-start/README.md) za začetek!
...
Začnite z modulom [Hitri začetek](00-quick-start/README.md) in nadaljujte skozi vsak modul, da boste korak za korakom razvijali svoje spretnosti. Preizkusili boste osnovne primere, da boste razumeli temelje, preden se premaknete v modul [Uvod](01-introduction/README.md) za poglobljeno spoznavanje z GPT-5.

<img src="../../translated_images/learning-path.ac2da6720e77c3165960835627cef4c20eb2afb103be73a4f25b6d8fafbd738d.sl.png" alt="Učna pot" width="800"/>
...
> **Opomba:** To usposabljanje uporablja tako GitHub Models kot Azure OpenAI. Modula [Hitri začetek](00-quick-start/README.md) in [MCP](05-mcp/README.md) uporabljata GitHub Models (ni potrebna naročnina na Azure), medtem ko moduli 1–4 uporabljajo Azure OpenAI GPT-5.


## Učenje z GitHub Copilot

Za hiter začetek programiranja odprite ta projekt v GitHub Codespace ali v svojem lokalnem IDE z zagotovljenim devcontainerjem. Devcontainer, uporabljen v tem tečaju, je predkonfiguriran z GitHub Copilot za AI skupinsko programiranje.

Vsak primer kode vključuje predlagana vprašanja, ki jih lahko postavite GitHub Copilotu za poglobitev razumevanja. Poiščite napotke 💡/🤖 v:

- **Java file headers** - Vprašanja specifična za vsak primer
- **Module READMEs** - Raziskovalna vprašanja po primerih kode

**Kako uporabljati:** Odprite katero koli datoteko s kodo in postavite Copilotu predlagana vprašanja. Ima poln kontekst kode in lahko razlaga, razširi in predlaga alternative.

Želite izvedeti več? Oglejte si [Copilot za AI skupinsko programiranje](https://aka.ms/GitHubCopilotAI).
...
[![Skupnost Azure AI Foundry na Discordu](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)
...
Licenca MIT - Za podrobnosti glejte datoteko [LICENSE](../../LICENSE).
