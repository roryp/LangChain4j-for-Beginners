...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-06T01:40:19+00:00",
...
**Новачок у LangChain4j?** Ознайомтеся зі [Словником](docs/GLOSSARY.md) для визначень ключових термінів і понять.

## Зміст

1. [Швидкий старт](00-quick-start/README.md) - Почніть працювати з LangChain4j
2. [Вступ](01-introduction/README.md) - Вивчайте основи LangChain4j
3. [Проектування підказок](02-prompt-engineering/README.md) - Опануйте ефективне створення підказок
4. [RAG (Retrieval-Augmented Generation)](03-rag/README.md) - Створюйте інтелектуальні системи на базі знань
...
3. Використовуйте налаштування за замовчуванням – таким чином обирається середовище розробки, створене для цього курсу
...
> **Примітка:** У цьому навчанні використовуються як GitHub Models, так і Azure OpenAI. Модуль [Швидкий старт](00-quick-start/README.md) використовує GitHub Models (підписка Azure не потрібна), тоді як модулі 1-5 використовують Azure OpenAI.

## Навчання з GitHub Copilot

Щоб швидко почати писати код, відкрийте цей проєкт у GitHub Codespace або у вашому локальному IDE з наданим devcontainer. Devcontainer, який використовується у цьому курсі, попередньо налаштований із GitHub Copilot для AI-парного програмування.
...
- **Заголовках Java-файлів** - питання, специфічні до кожного прикладу
- **READMEs модулів** - запити для дослідження після прикладів коду

**Як користуватися:** Відкрийте будь-який файл коду та задавайте запропоновані питання Copilot. Він має повний контекст коду і може пояснювати, розширювати і пропонувати альтернативи.
