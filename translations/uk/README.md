...
Курс зі створення AI-застосунків за допомогою LangChain4j і Azure OpenAI GPT-5 — від базового чату до AI-агентів.
...
2. [Вступ](01-introduction/README.md) – Основи LangChain4j
3. [Розробка запитів](02-prompt-engineering/README.md) – Опановуйте ефективний дизайн запитів
4. [RAG (Ретривал-доозброєний генерація)](03-rag/README.md) – Створення інтелектуальних систем на основі знань
5. [Інструменти](04-tools/README.md) – Інтеграція зовнішніх інструментів та простих помічників
6. [MCP (Протокол контексту моделі)](05-mcp/README.md) – Робота з MCP і агентськими модулями
---
...
1. Форкніть цей репозиторій до свого акаунту GitHub
2. Клацніть **Code** → вкладку **Codespaces** → **...** → **New with options...**
3. Використовуйте стандартні налаштування — буде вибрано контейнер розробки створений для цього курсу
4. Клацніть **Create codespace**
5. Зачекайте 5-10 хвилин, поки середовище буде готове
6. Перейдіть одразу до [Швидкий старт](./00-quick-start/README.md), щоб почати!

Після проходження модулів вивчіть [Посібник з тестування](docs/TESTING.md), щоб побачити концепції тестування LangChain4j на практиці.

> **Примітка:** Це навчання використовує як GitHub Models, так і Azure OpenAI. Модуль [Швидкий старт](00-quick-start/README.md) використовує GitHub Models (передплата Azure не потрібна), тоді як модулі 1-5 використовують Azure OpenAI.

## Навчання з GitHub Copilot

Щоб швидко почати кодувати, відкрийте цей проєкт у GitHub Codespace або у вашій локальній IDE із наданим devcontainer. Devcontainer, що використовується у цьому курсі, заздалегідь налаштований з GitHub Copilot для спільного AI-програмування.

Кожен приклад коду містить рекомендовані запитання, які можна поставити GitHub Copilot, щоб поглибити розуміння. Шукайте підказки 💡/🤖 у:

- **Заголовках Java-файлів** – запитання, специфічні для кожного прикладу
- **README модулів** – питання для дослідження після прикладів коду

**Як користуватися:** Відкрийте будь-який файл із кодом і задайте Copilot рекомендовані запитання. Copilot має повний контекст кодової бази і може пояснювати, розширювати та пропонувати альтернативи.

Хочете дізнатися більше? Перегляньте [Copilot для спільного AI-програмування](https://aka.ms/GitHubCopilotAI).
...
[![Веброзробка для початківців](https://img.shields.io/badge/Web%20Dev%20for%20Beginners-EC4899?style=for-the-badge&labelColor=E5E7EB&color=EC4899)](https://aka.ms/webdev-beginners?WT.mc_id=academic-105485-koreyst)
...
Якщо у вас є відгуки про продукт або ви помітили помилки під час розробки, відвідайте:
