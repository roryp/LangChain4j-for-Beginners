...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-31T06:18:37+00:00",
...
6. Перейдіть безпосередньо до [Quick Start](./00-quick-start/README.md), щоб розпочати!
...
> **Примітка:** Це навчання використовує як GitHub Models, так і Azure OpenAI. Модулі [Quick Start](00-quick-start/README.md) та [MCP](05-mcp/README.md) використовують GitHub Models (передплата Azure не потрібна), тоді як модулі 1–4 використовують Azure OpenAI GPT-5.


## Навчання з GitHub Copilot

Щоб швидко почати кодування, відкрийте цей проєкт у GitHub Codespace або у вашому локальному IDE з наданим devcontainer. Devcontainer, що використовується в цьому курсі, попередньо налаштований з GitHub Copilot для спільного програмування з AI.

Кожен приклад коду містить рекомендовані запитання, які ви можете задати GitHub Copilot, щоб поглибити своє розуміння. Шукайте підказки 💡/🤖 у:

- **Заголовках файлів Java** - Запитання, специфічні для кожного прикладу
- **README модулів** - Підказки для дослідження після прикладів коду

**Як використовувати:** Відкрийте будь-який файл коду й задайте Copilot рекомендовані запитання. Він має повний контекст коду та може пояснювати, розширювати і пропонувати альтернативи.

Хочете дізнатися більше? Перегляньте [Copilot for AI Paired Programming](https://aka.ms/GitHubCopilotAI).
...
Якщо ви застрягли або маєте запитання щодо створення додатків зі ШІ, приєднуйтесь:
...
Ліцензія MIT - див. файл [LICENSE](../../LICENSE) для подробиць.

---

<!-- CO-OP TRANSLATOR DISCLAIMER START -->
Відмова від відповідальності:
Цей документ було перекладено за допомогою сервісу перекладу зі штучним інтелектом [Co-op Translator](https://github.com/Azure/co-op-translator). Хоча ми прагнемо до точності, просимо зауважити, що автоматичні переклади можуть містити помилки або неточності. Оригінальний документ його рідною мовою слід вважати авторитетним джерелом. Для критично важливої інформації рекомендується звертатися до професійного людського перекладу. Ми не несемо відповідальності за будь-які непорозуміння або неправильні тлумачення, що виникли внаслідок використання цього перекладу.
