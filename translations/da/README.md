...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-31T01:26:27+00:00",
...
2. [Introduktion](01-introduction/README.md) - Lær grundprincipperne i LangChain4j
3. [Prompt-udformning](02-prompt-engineering/README.md) - Mestér effektivt promptdesign
4. [RAG (Retrieval-Augmented Generation)](03-rag/README.md) - Byg intelligente vidensbaserede systemer
5. [Værktøjer](04-tools/README.md) - Integrer eksterne værktøjer og enkle assistenter
...
3. Brug standardindstillingerne – dette vil vælge udviklingscontaineren, som er oprettet til dette kursus
4. Klik **Create codespace**
5. Vent 5-10 minutter på, at miljøet er klar
6. Spring direkte til [Kom godt i gang](./00-quick-start/README.md) for at komme i gang!

> **Foretrækker du at klone lokalt?**
>
> Dette repository indeholder 50+ sprogoversættelser, som øger downloadstørrelsen betydeligt. For at klone uden oversættelser, brug sparse checkout:
> ```bash
...
Efter at have gennemført modulerne, udforsk [Testvejledning](docs/TESTING.md) for at se LangChain4j-testkoncepter i praksis.

> **Bemærk:** Denne træning bruger både GitHub Models og Azure OpenAI. [Kom godt i gang](00-quick-start/README.md) og [MCP](05-mcp/README.md) modulerne bruger GitHub Models (intet Azure-abonnement kræves), mens moduler 1-4 bruger Azure OpenAI GPT-5.


## Læring med GitHub Copilot

For hurtigt at komme i gang med at kode, åbn dette projekt i en GitHub Codespace eller dit lokale IDE med den medfølgende devcontainer. Devcontaineren, der bruges i dette kursus, er forudkonfigureret med GitHub Copilot til AI-parprogrammering.

Hvert kodeeksempel indeholder foreslåede spørgsmål, du kan stille GitHub Copilot for at uddybe din forståelse. Kig efter 💡/🤖-opfordringerne i:

- **Java-filoverskrifter** - Spørgsmål specifikke for hvert eksempel
- **Modul-README'er** - Udforskningsspørgsmål efter kodeeksempler

**Sådan bruges det:** Åbn en hvilken som helst kodefil og stil Copilot de foreslåede spørgsmål. Den har fuld kontekst af kodebasen og kan forklare, udvide og foreslå alternativer.

Vil du lære mere? Se [Copilot til AI-parprogrammering](https://aka.ms/GitHubCopilotAI).
...
Hvis du har produktfeedback eller finder fejl under udviklingen, besøg:
