...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T23:49:07+00:00",
  "source_file": "README.md",
  "language_code": "no"
}
-->
<img src="../../translated_images/no/LangChain4j.90e1d693fcc71b50.png" alt="LangChain4j" width="800"/>
...
**Ny på LangChain4j?** Sjekk ut [Ordliste](docs/GLOSSARY.md) for definisjoner av nøkkelbegreper og konsepter.
...
3. [Prompt-utforming](02-prompt-engineering/README.md) - Mestre effektiv promptdesign
...
Etter å ha fullført modulene, utforsk [Testing Guiden](docs/TESTING.md) for å se LangChain4j testkonsepter i praksis.

> **Merk:** Denne opplæringen bruker både GitHub-modeller og Azure OpenAI. [Rask start](00-quick-start/README.md) bruker GitHub-modeller (ingen Azure-abonnement nødvendig), mens modulene 1–5 bruker Azure OpenAI.


## Læring med GitHub Copilot

For å raskt begynne å kode, åpne dette prosjektet i en GitHub Codespace eller din lokale IDE med den medfølgende devcontaineren. Devcontaineren som brukes i dette kurset kommer forhåndskonfigurert med GitHub Copilot for AI-parprogrammering.

Hvert kodeeksempel inkluderer foreslåtte spørsmål du kan stille GitHub Copilot for å utdype din forståelse. Se etter 💡/🤖 oppfordringer i:

- **Java-filoverskrifter** - Spørsmål spesifikke for hvert eksempel
- **Modul-README-filer** - Utforskningsspørsmål etter kodeeksempler
...
Hvis du har produktinnspill eller feilmeldinger under bygging, besøk:
