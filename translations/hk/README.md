...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T08:15:56+00:00",
...
要快速開始編碼，請在 GitHub Codespace 或本地 IDE 中開啟此專案，並使用提供的 devcontainer。本課程使用的 devcontainer 已預先配置 GitHub Copilot 以支援 AI 配對程式設計。
