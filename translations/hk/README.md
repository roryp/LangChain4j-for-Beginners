...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T14:16:36+00:00",
...
一門使用 LangChain4j 與 Azure OpenAI GPT-5 建立 AI 應用程式的課程，涵蓋從基本聊天到 AI 代理。
...
5. [工具](04-tools/README.md) - 與 AI 代理整合外部工具與 API
