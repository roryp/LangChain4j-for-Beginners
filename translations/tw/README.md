...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-16T08:47:27+00:00",
  "source_file": "README.md",
  "language_code": "tw"
}
-->
<img src="../../translated_images/tw/LangChain4j.90e1d693fcc71b50.webp" alt="LangChain4j" width="800"/>
...
> 本儲存庫包含超過50種語言的翻譯，會大幅增加下載大小。若要複製時不包含翻譯，請使用稀疏簽出：
> ```bash
> git clone --filter=blob:none --sparse https://github.com/microsoft/LangChain4j-for-Beginners.git
> cd LangChain4j-for-Beginners
> git sparse-checkout set --no-cone '/*' '!translations' '!translated_images'
> ```
> 這可讓您擁有完成課程所需的所有內容，且下載速度更快。
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

# LangChain4j 初學者入門

一個使用 LangChain4j 與 Azure OpenAI GPT-5 建構 AI 應用的課程，從基礎聊天到 AI 代理人。
...
2. 按下 **Code** → **Codespaces** 分頁 → **...** → **New with options...**
3. 使用預設值－這會選擇為本課程建立的開發容器
4. 點擊 **Create codespace**
5. 等候 5-10 分鐘直到環境準備完成
6. 直接跳到 [快速開始](./00-quick-start/README.md) 立即啟動！

完成模組後，請探索 [測試指南](docs/TESTING.md) 以實際了解 LangChain4j 的測試概念。

> **注意：** 本訓練同時使用 GitHub 模型與 Azure OpenAI。[快速開始](00-quick-start/README.md) 模組使用 GitHub 模型（無需 Azure 訂閱），而 1-5 模組使用 Azure OpenAI。


## 使用 GitHub Copilot 學習

要快速開始寫程式，請在 GitHub Codespace 或搭配提供的 devcontainer 的本機 IDE 中開啟本專案。本課程使用的 devcontainer 預先配置了 GitHub Copilot 以提供 AI 配對程式設計。

每個程式範例包含可問 GitHub Copilot 的建議問題，有助於加深理解。請留意：

- **Java 檔案標頭** - 每個範例專屬問題
- **模組 README** - 程式範例後的探索提示

**使用方法：** 打開任何程式檔案並向 Copilot 提問建議的問題。它能充分掌握程式碼庫上下文，並能說明、擴充或提供替代方案。
...
**免責聲明**：
本文件係使用 AI 翻譯服務 [Co-op Translator](https://github.com/Azure/co-op-translator) 進行翻譯。雖然我們力求準確，但請注意自動翻譯可能存在錯誤或不準確之處。原文文件的母語版本應視為權威來源。對於重要資訊，建議聘請專業人工翻譯。我們不對因使用本翻譯而產生的任何誤解或誤讀負責。
