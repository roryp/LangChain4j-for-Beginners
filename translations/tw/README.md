...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-13T12:19:06+00:00",
...
要快速開始編碼，請在 GitHub Codespace 或本地 IDE 中開啟此專案，並使用提供的 devcontainer。本課程使用的 devcontainer 已預先配置 GitHub Copilot，支援 AI 配對程式設計。
...
**使用方式：** 開啟任何程式碼檔案，向 Copilot 詢問建議問題。它擁有完整的程式碼庫上下文，能解釋、擴展並建議替代方案。
