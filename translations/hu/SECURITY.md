...
Ehelyett kérjük, jelentse a Microsoft Biztonsági Reagálási Központnak (MSRC) a [https://msrc.microsoft.com/create-report](https://aka.ms/security.md/msrc/create-report) címen.

Ha inkább bejelentkezés nélkül szeretne jelenteni, küldjön e-mailt a [secure@microsoft.com](mailto:secure@microsoft.com) címre. Ha lehetséges, titkosítsa üzenetét a PGP kulcsunkkal; kérjük, töltse le a [Microsoft Biztonsági Reagálási Központ PGP kulcs oldaláról](https://aka.ms/security.md/msrc/pgp).

Választ 24 órán belül kell kapnia. Ha valamilyen okból nem kap választ, kérjük, kövesse nyomon e-mailben, hogy megbizonyosodjunk arról, hogy megkaptuk az eredeti üzenetét. További információk találhatók a [microsoft.com/msrc](https://www.microsoft.com/msrc) oldalon.

Kérjük, hogy a jobb megértés érdekében a lehetséges probléma természetéről és kiterjedéséről az alábbi kért információkat (amennyit csak tud) mellékelje:
  ...
  * A probléma hatása, beleértve, hogy egy támadó hogyan használhatná ki a problémát

Ezek az információk segítenek minket abban, hogy gyorsabban kezeljük a jelentését.

Ha hibadíj program keretében jelent, a részletesebb jelentések hozzájárulhatnak magasabb díjazáshoz. Kérjük, látogasson el a [Microsoft Bug Bounty Program](https://aka.ms/security.md/msrc/bounty) oldalunkra, ahol további részleteket talál aktív programjainkról.

## Előnyben részesített nyelvek

Az összes kommunikációt angol nyelven részesítjük előnyben.
