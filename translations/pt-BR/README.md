...
> **Nota:** Este treinamento usa tanto GitHub Models quanto Azure OpenAI. O módulo [Início Rápido](00-quick-start/README.md) usa GitHub Models (não exige assinatura Azure), enquanto os módulos 1-5 usam Azure OpenAI.


## Aprendizado com GitHub Copilot

Para começar a codificar rapidamente, abra este projeto em um GitHub Codespace ou em seu IDE local com o devcontainer fornecido. O devcontainer usado neste curso vem pré-configurado com GitHub Copilot para programação assistida por IA.

Cada exemplo de código inclui perguntas sugeridas que você pode fazer ao GitHub Copilot para aprofundar seu entendimento. Procure pelos prompts 💡/🤖 em:

- **Cabeçalhos de arquivos Java** - Perguntas específicas para cada exemplo
- **READMEs dos módulos** - Perguntas de exploração após exemplos de código

**Como usar:** Abra qualquer arquivo de código e faça as perguntas sugeridas ao Copilot. Ele tem contexto completo do código e pode explicar, expandir e sugerir alternativas.
