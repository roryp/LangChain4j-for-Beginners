...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-23T10:51:19+00:00",
...
**Ново в LangChain4j?** Вижте [Глосар](docs/GLOSSARY.md) за определения на ключови термини и концепции.
...
4. [RAG (Генериране с извличане на информация)](03-rag/README.md) - Изградете интелигентни системи, базирани на знания
...
1. Направете fork на това хранилище в своя GitHub акаунт
...
5. Изчакайте 5-10 минути, докато средата бъде готова
...
Започнете с модула [Бърз старт](00-quick-start/README.md) и преминавайте през всеки модул, за да развивате уменията си стъпка по стъпка. Ще опитате базови примери, за да разберете основите, преди да преминете към модула [Въведение](01-introduction/README.md) за по-задълбочено разглеждане с GPT-5.

<img src="../../translated_images/learning-path.ac2da6720e77c3165960835627cef4c20eb2afb103be73a4f25b6d8fafbd738d.bg.png" alt="Учебен път" width="800"/>

След завършване на модулите, разгледайте [Ръководството за тестване](docs/TESTING.md), за да видите концепциите за тестване в LangChain4j в действие.

> **Забележка:** Това обучение използва както GitHub Models, така и Azure OpenAI. Модулите [Бърз старт](00-quick-start/README.md) и [MCP](05-mcp/README.md) използват GitHub Models (не се изисква абонамент за Azure), докато модулите 1-4 използват Azure OpenAI GPT-5.


## Обучение с GitHub Copilot

За бърз старт на кодирането, отворете този проект в GitHub Codespace или в локалното си IDE с предоставения devcontainer. Devcontainer-ът, използван в този курс, е предварително конфигуриран с GitHub Copilot за AI съвместно програмиране.
...
- **Java file headers** - Въпроси, специфични за всеки пример
- **README файлове на модулите** - Подсказки за проучване след примерите с код

**Как да използвате:** Отворете всеки кодов файл и задайте на Copilot предложените въпроси. Той има пълен контекст на кодовата база и може да обяснява, разширява и предлага алтернативи.
