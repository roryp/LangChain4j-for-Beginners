...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-06T01:08:14+00:00",
  "source_file": "README.md",
  "language_code": "bg"
}
-->
<img src="../../translated_images/bg/LangChain4j.90e1d693fcc71b50.png" alt="LangChain4j" width="800"/>
...
> Това репозитори включва над 50 езикови превода, което значително увеличава размера за изтегляне. За да клонирате без преводи, използвайте sparse checkout:
> ```bash
...
**Нови в LangChain4j?** Разгледайте [Речника](docs/GLOSSARY.md) за дефиниции на ключови термини и концепции.
...
3. [Проектиране на промпти](02-prompt-engineering/README.md) - Овладейте ефективното проектиране на промпти
4. [RAG (Retrieval-Augmented Generation)](03-rag/README.md) - Създайте интелигентни системи, базирани на знания
5. [Инструменти](04-tools/README.md) - Интегрирайте външни инструменти и прости асистенти
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Работа с Model Context Protocol (MCP) и агентни модули
---
...
1. Форкнете това репозитори в своя GitHub акаунт
2. Кликнете **Code** → таб **Codespaces** → **...** → **New with options...**
...
5. Изчакайте 5-10 минути за подготовка на средата
6. Преминете направо към [Бърз старт](./00-quick-start/README.md), за да започнете!
...
> **Забележка:** Това обучение използва както GitHub модели, така и Azure OpenAI. Модулът [Бърз старт](00-quick-start/README.md) използва GitHub модели (не се изисква абонамент за Azure), докато модулите 1-5 използват Azure OpenAI.


## Обучение с GitHub Copilot

За бърз старт на програмирането, отворете този проект в GitHub Codespace или в локалната си IDE с предоставения devcontainer. Devcontainer, използван в този курс, е предварително конфигуриран с GitHub Copilot за AI комбинирано програмиране.
...
- **README файлове на модулите** - Промпти за изследване след примерите с код

**Как да използвате:** Отворете всеки кодов файл и задайте на Copilot предложените въпроси. Той има пълен контекст на кода и може да обясни, разшири и предложи алтернативи.

Искате ли да научите повече? Вижте [Copilot за AI комбинирано програмиране](https://aka.ms/GitHubCopilotAI).
