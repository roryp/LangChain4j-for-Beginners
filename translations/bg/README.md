...
3. [Проектиране на подсказки](02-prompt-engineering/README.md) - Овладейте ефективния дизайн на подсказки
...
За бърз старт с кодирането отворете този проект в GitHub Codespace или в локалната си IDE с предоставения devcontainer. Devcontainer-ът, използван в този курс, е предварително конфигуриран с GitHub Copilot за AI съвместно програмиране.
