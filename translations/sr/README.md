...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T14:59:55+00:00",
...
Почните са модулом [Брзи почетак](00-quick-start/README.md) и напредујте кроз сваки модул корак по корак да бисте развили своје вештине. Пробаћете основне примере да бисте разумели основе пре него што пређете на модул [Увод](01-introduction/README.md) за дубље упознавање са GPT-5.
...
> **Напомена:** Овај тренинг користи и GitHub моделе и Azure OpenAI. Модули [Брзи почетак](00-quick-start/README.md) и [MCP](05-mcp/README.md) користе GitHub моделе (није потребна Azure претплата), док модули 1-4 користе Azure OpenAI GPT-5.
