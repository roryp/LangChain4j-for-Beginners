...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-16T11:48:46+00:00",
...
Курс за креирање AI апликација са LangChain4j и Azure OpenAI GPT-5, од основног чата до AI агената.
...
3. [Обрада упита](02-prompt-engineering/README.md) - Усавршите дизајн упита
...
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Рад са Протоколом контекста модела (MCP) и Agents модулом
---
...
3. Користите подразумеване опције – биће изабран Development контейнер креиран за овај курс
4. Кликните **Create codespace**
5. Сачекајте 5-10 минута да се окружење припреми
6. Идите директно на [Брзи почетак](./00-quick-start/README.md) да започнете!

Након завршетка модула, истражите [Водич за тестирање](docs/TESTING.md) да видите концепте тестирања LangChain4j у пракси.

> **Напомена:** Ова обука користи и GitHub моделе и Azure OpenAI. Модул [Брзи почетак](00-quick-start/README.md) користи GitHub моделе (није потребна Azure претплата), док модули 1-5 користе Azure OpenAI.

## Учење са GitHub Copilot-ом

Да бисте брзо почели са програмирањем, отворите овај пројекат у GitHub Codespace-у или у свом локалном IDE-ју уз пружени devcontainer. Devcontainer који се користи у овом курсу је претходно конфигурисан са GitHub Copilot-ом за AI парно програмирање.

Свако пример кода укључује предложена питања која можете поставити GitHub Copilot-у да дубље разумете материју. Потражите 💡/🤖 упутства у:

- **Java заглављима фајлова** - Питања специфична за сваки пример
- **Module README фајловима** - Упутства за даље истраживање након примера кода

**Како користити:** Отворите било који файл кода и поставите Copilot-у предложена питања. Он има пун приступ кодној бази и може да објасни, прошири и предложи алтернативе.
