...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T10:45:43+00:00",
...
Почните са модулом [Брзи почетак](00-quick-start/README.md) и напредујте кроз сваки модул корак по корак. Пробаћете основне примере да разумете основе пре него што пређете на модул [Увод](01-introduction/README.md) за дубље упознавање са GPT-5.
