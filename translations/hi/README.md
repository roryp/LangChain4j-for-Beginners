...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-18T09:39:02+00:00",
...
[त्वरित शुरुआत](00-quick-start/README.md) मॉड्यूल से शुरू करें और प्रत्येक मॉड्यूल के माध्यम से चरण-दर-चरण अपनी कौशल विकसित करें। आप मूल बातें समझने के लिए बुनियादी उदाहरणों को आज़माएंगे, फिर GPT-5 के साथ गहराई से जानने के लिए [परिचय](01-introduction/README.md) मॉड्यूल पर जाएंगे।
...
> **ध्यान दें:** यह प्रशिक्षण GitHub मॉडल और Azure OpenAI दोनों का उपयोग करता है। [त्वरित शुरुआत](00-quick-start/README.md) और [MCP](05-mcp/README.md) मॉड्यूल GitHub मॉडल का उपयोग करते हैं (कोई Azure सदस्यता आवश्यक नहीं), जबकि मॉड्यूल 1-4 Azure OpenAI GPT-5 का उपयोग करते हैं।
...
प्रत्येक कोड उदाहरण में सुझाए गए प्रश्न शामिल हैं जिन्हें आप GitHub Copilot से पूछ सकते हैं ताकि आपकी समझ गहरी हो सके। 💡/🤖 संकेतों को देखें:
