...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T08:20:49+00:00",
  "source_file": "README.md",
  "language_code": "hi"
}
-->
<img src="../../translated_images/LangChain4j.90e1d693fcc71b506e9588f734989dd106ebd9f977b7f784941a28b88348f0d6.hi.png" alt="LangChain4j" width="800"/>
...
LangChain4j और Azure OpenAI GPT-5 के साथ AI एप्लिकेशन बनाने के लिए एक कोर्स, बेसिक चैट से लेकर AI एजेंट्स तक।
...
5. [उपकरण](04-tools/README.md) - AI एजेंट्स के साथ बाहरी उपकरण और API एकीकृत करें
6. [MCP (मॉडल कॉन्टेक्स्ट प्रोटोकॉल)](05-mcp/README.md) - मॉडल कॉन्टेक्स्ट प्रोटोकॉल के साथ काम करें
---
...
6. सीधे [त्वरित शुरुआत](./00-quick-start/README.md) पर जाएं और शुरू करें!
...
[त्वरित शुरुआत](00-quick-start/README.md) मॉड्यूल से शुरू करें और प्रत्येक मॉड्यूल के माध्यम से चरण-दर-चरण अपनी कौशल विकसित करें। आप मूल बातें समझने के लिए बुनियादी उदाहरणों को आजमाएंगे, फिर GPT-5 के साथ गहराई से जानने के लिए [परिचय](01-introduction/README.md) मॉड्यूल पर जाएंगे।

<img src="../../translated_images/learning-path.ac2da6720e77c3165960835627cef4c20eb2afb103be73a4f25b6d8fafbd738d.hi.png" alt="Learning Path" width="800"/>
...
> **नोट:** यह प्रशिक्षण GitHub मॉडल और Azure OpenAI दोनों का उपयोग करता है। [त्वरित शुरुआत](00-quick-start/README.md) और [MCP](05-mcp/README.md) मॉड्यूल GitHub मॉडल का उपयोग करते हैं (कोई Azure सदस्यता आवश्यक नहीं), जबकि मॉड्यूल 1-4 Azure OpenAI GPT-5 का उपयोग करते हैं।


## GitHub Copilot के साथ सीखना

कोडिंग जल्दी शुरू करने के लिए, इस प्रोजेक्ट को GitHub Codespace या आपके स्थानीय IDE में प्रदान किए गए devcontainer के साथ खोलें। इस कोर्स में उपयोग किया गया devcontainer GitHub Copilot के साथ AI पेयर्ड प्रोग्रामिंग के लिए पूर्व-कॉन्फ़िगर किया गया है।

प्रत्येक कोड उदाहरण में सुझाए गए प्रश्न शामिल हैं जिन्हें आप GitHub Copilot से पूछ सकते हैं ताकि आपकी समझ गहरी हो सके। 💡/🤖 संकेतों के लिए देखें:

- **Java फ़ाइल हेडर** - प्रत्येक उदाहरण के लिए विशिष्ट प्रश्न
- **मॉड्यूल README** - कोड उदाहरणों के बाद अन्वेषण संकेत

**कैसे उपयोग करें:** कोई भी कोड फ़ाइल खोलें और Copilot से सुझाए गए प्रश्न पूछें। इसके पास कोडबेस का पूरा संदर्भ है और यह समझा सकता है, बढ़ा सकता है, और विकल्प सुझा सकता है।

और जानना चाहते हैं? देखें [AI पेयर्ड प्रोग्रामिंग के लिए Copilot](https://aka.ms/GitHubCopilotAI)।
