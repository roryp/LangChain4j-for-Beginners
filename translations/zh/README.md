...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-16T08:32:38+00:00",
...
[阿拉伯语](../ar/README.md) | [孟加拉语](../bn/README.md) | [保加利亚语](../bg/README.md) | [缅甸语](../my/README.md) | [中文（简体）](./README.md) | [中文（繁体，香港）](../hk/README.md) | [中文（繁体，澳门）](../mo/README.md) | [中文（繁体，台湾）](../tw/README.md) | [克罗地亚语](../hr/README.md) | [捷克语](../cs/README.md) | [丹麦语](../da/README.md) | [荷兰语](../nl/README.md) | [爱沙尼亚语](../et/README.md) | [芬兰语](../fi/README.md) | [法语](../fr/README.md) | [德语](../de/README.md) | [希腊语](../el/README.md) | [希伯来语](../he/README.md) | [印地语](../hi/README.md) | [匈牙利语](../hu/README.md) | [印度尼西亚语](../id/README.md) | [意大利语](../it/README.md) | [日语](../ja/README.md) | [卡纳达语](../kn/README.md) | [韩语](../ko/README.md) | [立陶宛语](../lt/README.md) | [马来语](../ms/README.md) | [马拉雅拉姆语](../ml/README.md) | [马拉地语](../mr/README.md) | [尼泊尔语](../ne/README.md) | [尼日利亚皮钦语](../pcm/README.md) | [挪威语](../no/README.md) | [波斯语（法尔西语）](../fa/README.md) | [波兰语](../pl/README.md) | [葡萄牙语（巴西）](../br/README.md) | [葡萄牙语（葡萄牙）](../pt/README.md) | [旁遮普语（古鲁姆奇文）](../pa/README.md) | [罗马尼亚语](../ro/README.md) | [俄语](../ru/README.md) | [塞尔维亚语（西里尔文）](../sr/README.md) | [斯洛伐克语](../sk/README.md) | [斯洛文尼亚语](../sl/README.md) | [西班牙语](../es/README.md) | [斯瓦希里语](../sw/README.md) | [瑞典语](../sv/README.md) | [他加禄语（菲律宾语）](../tl/README.md) | [泰米尔语](../ta/README.md) | [泰卢固语](../te/README.md) | [泰语](../th/README.md) | [土耳其语](../tr/README.md) | [乌克兰语](../uk/README.md) | [乌尔都语](../ur/README.md) | [越南语](../vi/README.md)

> **想要本地克隆？**

> 本仓库包含 50 多种语言的翻译版，显著增加了下载大小。若想不包含翻译克隆代码，请使用稀疏检出：
> ```bash
> git clone --filter=blob:none --sparse https://github.com/microsoft/LangChain4j-for-Beginners.git
> cd LangChain4j-for-Beginners
> git sparse-checkout set --no-cone '/*' '!translations' '!translated_images'
> ```
> 这样可以更快下载，获得完成课程所需的全部内容。
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

# LangChain4j 入门

一门使用 LangChain4j 和 Azure OpenAI GPT-5 构建 AI 应用的课程，从基础聊天到 AI 代理。

**刚接触 LangChain4j？** 查看 [术语表](docs/GLOSSARY.md)，了解关键术语和概念定义。

## 目录

1. [快速开始](00-quick-start/README.md) - 快速上手 LangChain4j  
2. [介绍](01-introduction/README.md) - 了解 LangChain4j 基础知识  
3. [提示工程](02-prompt-engineering/README.md) - 掌握高效提示设计  
...
2. 点击 **代码** → **Codespaces** 选项卡 → **...** → **带选项新建...**  
3. 采用默认设置 – 会选择本课程创建的开发容器  
4. 点击 **创建代码空间**  
5. 等待 5-10 分钟，环境准备完成  
6. 直接跳转到 [快速开始](./00-quick-start/README.md) 入门！

完成所有模块后，探索[测试指南](docs/TESTING.md)，了解 LangChain4j 测试概念实操。

> **注意：** 本培训使用 GitHub Models 和 Azure OpenAI。 [快速开始](00-quick-start/README.md) 模块使用 GitHub Models（无需 Azure 订阅），而 1-5 模块使用 Azure OpenAI。

## 使用 GitHub Copilot 学习

要快速开始编码，可在 GitHub Codespace 或本地 IDE 中打开本项目并使用提供的 devcontainer。本课程使用的 devcontainer 已预配置 GitHub Copilot，用于 AI 配对编程。

每个代码示例都包含可询问 GitHub Copilot 的建议问题，助你加深理解。请注意以下位置的 💡/🤖 提示：

- **Java 文件头部** - 针对具体示例的问题  
- **模块说明文件** - 代码示例后的探索提示  

**使用方法：** 打开任意代码文件，向 Copilot 提出建议问题。它拥有完整代码上下文，能解释、扩展及建议替代方案。

想了解更多？访问 [AI 配对编程的 Copilot](https://aka.ms/GitHubCopilotAI)。
...
[![AI 结对编程助手 Copilot](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
**免责声明**：  
本文件使用 AI 翻译服务 [Co-op Translator](https://github.com/Azure/co-op-translator) 进行翻译。尽管我们力求准确，但请注意，自动翻译可能存在错误或不准确之处。原始文件的母语版本应视为权威来源。对于重要信息，建议采用专业人工翻译。对于因使用本翻译而产生的任何误解或误读，我们概不负责。
