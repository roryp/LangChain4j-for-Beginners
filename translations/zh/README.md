...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T11:01:10+00:00",
...
从[快速入门](00-quick-start/README.md)模块开始，逐步完成每个模块，逐步提升技能。你将尝试基础示例以理解基础知识，然后进入[介绍](01-introduction/README.md)模块，深入学习 GPT-5。
...
> **注意：** 本培训同时使用 GitHub 模型和 Azure OpenAI。[快速入门](00-quick-start/README.md)和[MCP](05-mcp/README.md)模块使用 GitHub 模型（无需 Azure 订阅），而模块 1-4 使用 Azure OpenAI GPT-5。
