...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T21:24:06+00:00",
  "source_file": "README.md",
  "language_code": "de"
}
-->
<img src="../../translated_images/de/LangChain4j.90e1d693fcc71b50.png" alt="LangChain4j" width="800"/>
...
**Neu bei LangChain4j?** Schauen Sie sich das [Glossar](docs/GLOSSARY.md) an für Definitionen wichtiger Begriffe und Konzepte.
...
5. [Tools](04-tools/README.md) - Externe Werkzeuge und einfache Assistenten integrieren
...
2. Klicken Sie auf **Code** → Tab **Codespaces** → **...** → **New with options...**
...
Nach Abschluss der Module erkunden Sie den [Testleitfaden](docs/TESTING.md), um die LangChain4j-Testkonzepte in der Praxis zu sehen.

> **Hinweis:** Diese Schulung verwendet sowohl GitHub-Modelle als auch Azure OpenAI. Das Modul [Schnellstart](00-quick-start/README.md) nutzt GitHub-Modelle (keine Azure-Abonnement erforderlich), während die Module 1-5 Azure OpenAI verwenden.


## Lernen mit GitHub Copilot

Um schnell mit dem Programmieren zu beginnen, öffnen Sie dieses Projekt in einem GitHub Codespace oder in Ihrer lokalen IDE mit dem bereitgestellten devcontainer. Der im Kurs verwendete devcontainer ist vorkonfiguriert mit GitHub Copilot für KI-gestützte Paarprogrammierung.
...
- **Modul-READMEs** - Erkundungshinweise nach Codebeispielen

**Wie man es verwendet:** Öffnen Sie eine beliebige Code-Datei und stellen Sie Copilot die vorgeschlagenen Fragen. Es hat den vollständigen Kontext des Codes und kann erklären, erweitern und Alternativen vorschlagen.
...
Wenn Sie stecken bleiben oder Fragen zum Erstellen von KI-Apps haben, treten Sie bei:
...
**Haftungsausschluss**:  
Dieses Dokument wurde mit dem KI-Übersetzungsdienst [Co-op Translator](https://github.com/Azure/co-op-translator) übersetzt. Obwohl wir auf Genauigkeit achten, können automatisierte Übersetzungen Fehler oder Ungenauigkeiten enthalten. Das ursprüngliche Dokument in seiner Ursprungssprache gilt als maßgebliche Quelle. Bei wichtigen Informationen wird eine professionelle menschliche Übersetzung empfohlen. Wir übernehmen keine Haftung für Missverständnisse oder Fehlinterpretationen, die aus der Nutzung dieser Übersetzung entstehen.
