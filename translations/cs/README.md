...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T11:42:39+00:00",
...
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Práce s protokolem Model Context
---

## Výuková cesta

Začněte modulem [Rychlý start](00-quick-start/README.md) a postupujte krok za krokem přes jednotlivé moduly, abyste si vybudovali dovednosti. Vyzkoušíte základní příklady pro pochopení základů, než přejdete k modulu [Úvod](01-introduction/README.md) pro hlubší seznámení s GPT-5.
...
> **Poznámka:** Tento kurz využívá jak GitHub modely, tak Azure OpenAI. Moduly [Rychlý start](00-quick-start/README.md) a [MCP](05-mcp/README.md) používají GitHub modely (není potřeba předplatné Azure), zatímco moduly 1-4 používají Azure OpenAI GPT-5.
...
Každý příklad kódu obsahuje navrhované otázky, které můžete položit GitHub Copilotovi pro lepší pochopení. Hledejte výzvy 💡/🤖 v:
