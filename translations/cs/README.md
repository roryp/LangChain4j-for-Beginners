...
Začněte modulem [Rychlý start](00-quick-start/README.md) a postupujte krok za krokem přes každý modul, abyste si vybudovali dovednosti. Vyzkoušíte základní příklady pro pochopení základů, než přejdete do modulu [Úvod](01-introduction/README.md) pro hlubší seznámení s GPT-5.
