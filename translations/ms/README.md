...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-16T09:19:20+00:00",
...
> ```
> Ini memberi anda semua yang anda perlukan untuk menyelesaikan kursus dengan muat turun yang jauh lebih pantas.
...
1. [Mula Pantas](00-quick-start/README.md) - Mula dengan LangChain4j
...
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Bekerja dengan Protokol Konteks Model (MCP) dan modul Agenetik
---
...
2. Klik **Kod** → tab **Codespaces** → **...** → **Baru dengan pilihan...**
...
6. Terus pergi ke [Mula Pantas](./00-quick-start/README.md) untuk bermula!

Selepas menyelesaikan modul, terokai [Panduan Ujian](docs/TESTING.md) untuk melihat konsep ujian LangChain4j dalam tindakan.

> **Nota:** Latihan ini menggunakan kedua-dua Model GitHub dan Azure OpenAI. Modul [Mula Pantas](00-quick-start/README.md) menggunakan Model GitHub (tidak memerlukan langganan Azure), manakala modul 1-5 menggunakan Azure OpenAI.


## Pembelajaran dengan GitHub Copilot

Untuk memulakan pengekodan dengan cepat, buka projek ini dalam GitHub Codespace atau IDE tempatan anda dengan devcontainer yang disediakan. Devcontainer yang digunakan dalam kursus ini telah dikonfigurasikan terlebih dahulu dengan GitHub Copilot untuk pengaturcaraan berpasangan AI.

Setiap contoh kod termasuk soalan yang disyorkan yang boleh anda tanya kepada GitHub Copilot untuk mendalami pemahaman anda. Cari petunjuk 💡/🤖 dalam:

- **Tajuk fail Java** - Soalan khusus untuk setiap contoh
- **README modul** - Petunjuk penerokaan selepas contoh kod

**Cara menggunakan:** Buka mana-mana fail kod dan tanya Copilot soalan yang disyorkan. Ia mempunyai konteks penuh kod dan boleh menjelaskan, melanjutkan, dan mencadangkan alternatif.
...
[![AI Edge untuk Pemula](https://img.shields.io/badge/Edge%20AI%20for%20Beginners-00B8E4?style=for-the-badge&labelColor=E5E7EB&color=00B8E4)](https://github.com/microsoft/edgeai-for-beginners?WT.mc_id=academic-105485-koreyst)
...
Lesen MIT - Lihat fail [LICENSE](../../LICENSE) untuk perincian.
