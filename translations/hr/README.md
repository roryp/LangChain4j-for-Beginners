...
> ```
> Ovo vam daje sve što vam treba da dovršite tečaj sa znatno bržim preuzimanjem.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

# LangChain4j za početnike

Tečaj za izradu AI aplikacija koristeći LangChain4j i Azure OpenAI GPT-5, od osnovnog čavrljanja do AI agenata.

**Novi ste u LangChain4j?** Pogledajte [Rječnik](docs/GLOSSARY.md) za definicije ključnih pojmova i koncepata.

## Sadržaj

1. [Brzi početak](00-quick-start/README.md) - Počnite koristiti LangChain4j
2. [Uvod](01-introduction/README.md) - Naučite osnove LangChain4j
3. [Inženjering upita](02-prompt-engineering/README.md) - Ovladavanje učinkovitim dizajnom upita
4. [RAG (Generiranje popraćeno dohvatom)](03-rag/README.md) - Izgradite inteligentne sustave temeljene na znanju
...
2. Kliknite **Code** → kartica **Codespaces** → **...** → **Novo s opcijama...**
3. Koristite zadane postavke – time će se odabrati razvojno okruženje kreirano za ovaj tečaj
4. Kliknite **Create codespace**
5. Pričekajte 5-10 minuta dok se okruženje spremi
...
> **Napomena:** Ova obuka koristi GitHub modele i Azure OpenAI. Modul [Brzi početak](00-quick-start/README.md) koristi GitHub modele (nije potreban Azure pretplata), dok moduli 1-5 koriste Azure OpenAI.


## Učenje uz GitHub Copilot

Za brzi početak kodiranja, otvorite ovaj projekt u GitHub Codespaceu ili u svojem lokalnom IDE-u koristeći pruženi devcontainer. Devcontainer korišten u ovom tečaju dolazi unaprijed konfiguriran s GitHub Copilotom za AI uparenog programiranja.

Svaki kodni primjer uključuje predložena pitanja koja možete postaviti GitHub Copilotu za dublje razumijevanje. Potražite oznake 💡/🤖 u:

- **zaglavlju Java datoteka** - pitanja specifična za svaki primjer
- **README-u modula** - istraživački upiti nakon primjera koda

**Kako koristiti:** otvorite bilo koju datoteku koda i postavite Copilotu predložena pitanja. Ima kompletan kontekst baze koda i može objasniti, proširiti i predložiti alternative.
