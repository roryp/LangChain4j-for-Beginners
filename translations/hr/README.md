...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-16T11:50:57+00:00",
...
3. [Inženjering prompta](02-prompt-engineering/README.md) - Savladajte učinkoviti dizajn promptova
4. [RAG (generiranje potpomognuto dohvaćanjem)](03-rag/README.md) - Izgradite inteligentne sustave temeljene na znanju
...
Za brz početak kodiranja, otvorite ovaj projekt u GitHub Codespace ili svom lokalnom IDE-u s priloženim devcontainerom. Devcontainer korišten u ovom tečaju dolazi predkonfiguriran s GitHub Copilot za AI upareno programiranje.
...
**Kako koristiti:** Otvorite bilo koju kodnu datoteku i postavite Copilotu predložena pitanja. Ima potpuni kontekst baze koda i može objasniti, proširiti i predložiti alternative.
