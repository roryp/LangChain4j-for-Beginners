...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-23T10:08:30+00:00",
...
Een cursus voor het bouwen van AI-toepassingen met LangChain4j en Azure OpenAI GPT-5, van eenvoudige chat tot AI-agents.

**Nieuw met LangChain4j?** Bekijk de [Woordenlijst](docs/GLOSSARY.md) voor definities van kernbegrippen en concepten.

## Table of Contents

1. [Quick Start](00-quick-start/README.md) - Aan de slag met LangChain4j
2. [Introduction](01-introduction/README.md) - Leer de basisprincipes van LangChain4j
...
5. [Tools](04-tools/README.md) - Integreer externe tools en API's met AI-agents
...
3. Gebruik de defaults – dit selecteert de Development container created for this course
4. Klik **Create codespace**
5. Wacht 5-10 minuten voor de omgeving klaar is
6. Ga rechtstreeks naar de [Snel aan de slag](./00-quick-start/README.md) om te beginnen!

> **Wil je liever lokaal klonen?**
>
> Deze repository bevat 50+ taalvertalingen waardoor de downloadgrootte aanzienlijk toeneemt. Om te klonen zonder vertalingen, gebruik sparse checkout:
> ```bash
...
Begin met de [Snel aan de slag](00-quick-start/README.md) module en werk door elke module om je vaardigheden stap voor stap op te bouwen. Je probeert eenvoudige voorbeelden om de basis te begrijpen voordat je doorgaat naar de [Introductie](01-introduction/README.md) module voor een diepere duik met GPT-5.
...
Na het voltooien van de modules, bekijk de [Testgids](docs/TESTING.md) om LangChain4j-testconcepten in actie te zien.

> **Opmerking:** Deze training maakt gebruik van zowel GitHub Models als Azure OpenAI. De [Snel aan de slag](00-quick-start/README.md) en [MCP](05-mcp/README.md) modules gebruiken GitHub Models (geen Azure-abonnement vereist), terwijl modules 1-4 Azure OpenAI GPT-5 gebruiken.
...
- **Java file headers** - Vragen specifiek voor elk voorbeeld
- **Module READMEs** - Verkenningsvragen na codevoorbeelden

**Hoe te gebruiken:** Open elk codebestand en stel Copilot de voorgestelde vragen. Het heeft volledige context van de codebase en kan uitleggen, uitbreiden en alternatieven suggereren.

Wil je meer weten? Bekijk [Copilot voor AI-gepaard programmeren](https://aka.ms/GitHubCopilotAI).
...
[![Ontwikkelaarsforum van Azure AI Foundry](https://img.shields.io/badge/GitHub-Azure_AI_Foundry_Developer_Forum-blue?style=for-the-badge&logo=github&color=000000&logoColor=fff)](https://aka.ms/foundry/forum)
