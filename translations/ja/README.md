...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-18T09:36:51+00:00",
...
すぐにコーディングを始めるには、このプロジェクトを GitHub Codespace またはローカル IDE で devcontainer を使って開きます。本コースで使う devcontainer は GitHub Copilot による AI ペアプログラミングが事前設定されています。
