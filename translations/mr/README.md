...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-13T12:23:14+00:00",
...
2. [परिचय](01-introduction/README.md) - LangChain4j चे मूलतत्त्वे शिका
...
[त्वरित प्रारंभ](00-quick-start/README.md) मॉड्यूलपासून सुरू करा आणि प्रत्येक मॉड्यूलमधून टप्प्याटप्प्याने आपले कौशल्य वाढवा. मूलभूत समजण्यासाठी आपण मूलभूत उदाहरणे वापराल आणि नंतर GPT-5 सह सखोल अभ्यासासाठी [परिचय](01-introduction/README.md) मॉड्यूलकडे जा.
...
त्वरित कोडिंग सुरू करण्यासाठी, हा प्रकल्प GitHub Codespace मध्ये किंवा आपल्या स्थानिक IDE मध्ये दिलेल्या devcontainer सह उघडा. या कोर्समध्ये वापरलेला devcontainer GitHub Copilot सह AI जोडलेले प्रोग्रामिंगसाठी पूर्व-संरचित आहे.

प्रत्येक कोड उदाहरणात GitHub Copilot कडून विचारू शकणारे सुचवलेले प्रश्न असतात जेणेकरून आपली समज अधिक खोल होईल. 💡/🤖 संकेतांसाठी पहा:

- **Java फाइल हेडर्स** - प्रत्येक उदाहरणासाठी विशिष्ट प्रश्न
- **मॉड्यूल README** - कोड उदाहरणांनंतर अन्वेषण प्रश्न

**कसे वापरावे:** कोणतीही कोड फाइल उघडा आणि Copilot कडे सुचवलेले प्रश्न विचारा. त्याला कोडबेसचा पूर्ण संदर्भ आहे आणि तो समजावून सांगू शकतो, विस्तार करू शकतो आणि पर्याय सुचवू शकतो.
