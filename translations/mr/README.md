...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T08:23:13+00:00",
...
4. [RAG (रिट्रीव्हल-अगमेंटेड जनरेशन)](03-rag/README.md) - बुद्धिमान ज्ञानाधारित प्रणाली तयार करा
...
3. डीफॉल्ट वापरा – यामुळे या कोर्ससाठी तयार केलेला विकास कंटेनर निवडला जाईल
4. क्लिक करा **Create codespace**
5. पर्यावरण तयार होण्यासाठी 5-10 मिनिटे प्रतीक्षा करा
6. थेट [त्वरित प्रारंभ](./00-quick-start/README.md) कडे जा आणि सुरुवात करा!

> **स्थानिक क्लोन करायचे आहे का?**
>
> या रेपॉजिटरीमध्ये 50+ भाषा अनुवाद आहेत ज्यामुळे डाउनलोड आकार मोठा होतो. अनुवादांशिवाय क्लोन करण्यासाठी sparse checkout वापरा:
> ```bash
...
[त्वरित प्रारंभ](00-quick-start/README.md) मॉड्यूलपासून सुरुवात करा आणि प्रत्येक मॉड्यूलमधून टप्प्याटप्प्याने आपले कौशल्य वाढवा. मूलभूत समजण्यासाठी सोपे उदाहरणे वापरून पहा आणि नंतर GPT-5 सह सखोल अभ्यासासाठी [परिचय](01-introduction/README.md) मॉड्यूलमध्ये जा.
...
त्वरित कोडिंग सुरू करण्यासाठी, हा प्रकल्प GitHub Codespace मध्ये किंवा आपल्या स्थानिक IDE मध्ये दिलेल्या devcontainer सह उघडा. या कोर्समध्ये वापरलेला devcontainer GitHub Copilot सह पूर्व-संरचित आहे, जो AI जोडलेल्या प्रोग्रामिंगसाठी आहे.

प्रत्येक कोड उदाहरणात GitHub Copilot कडून विचारू शकणारे सुचवलेले प्रश्न असतात जे आपली समज अधिक खोल करण्यास मदत करतात. 💡/🤖 संकेतांसाठी पहा:

- **Java फाइल हेडर** - प्रत्येक उदाहरणासाठी विशिष्ट प्रश्न
- **मॉड्यूल README** - कोड उदाहरणांनंतर अन्वेषण प्रश्न
...
अधिक जाणून घ्यायचे आहे का? [AI जोडलेल्या प्रोग्रामिंगसाठी Copilot](https://aka.ms/GitHubCopilotAI) पहा.
