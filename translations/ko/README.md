...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T08:20:04+00:00",
...
> **참고:** 이 교육 과정은 GitHub 모델과 Azure OpenAI를 모두 사용합니다. [빠른 시작](00-quick-start/README.md) 및 [MCP](05-mcp/README.md) 모듈은 GitHub 모델을 사용하며 (Azure 구독 불필요), 1-4 모듈은 Azure OpenAI GPT-5를 사용합니다.
