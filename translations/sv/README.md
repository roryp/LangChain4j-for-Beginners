...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-16T10:24:28+00:00",
...
En kurs för att bygga AI-applikationer med LangChain4j och Azure OpenAI GPT-5, från enkel chatt till AI-agenter.
...
2. Klicka på **Code** → **Codespaces**-fliken → **...** → **Nytt med alternativ...**
...
Efter att ha genomfört modulerna, utforska [Testguiden](docs/TESTING.md) för att se LangChain4js testkoncept i praktiken.

> **Notera:** Denna utbildning använder både GitHub Models och Azure OpenAI. [Snabbstart](00-quick-start/README.md) modulen använder GitHub Models (ingen Azure-prenumeration krävs), medan modulerna 1-5 använder Azure OpenAI.
...
Varje kodexempel inkluderar föreslagna frågor du kan ställa till GitHub Copilot för att fördjupa din förståelse. Leta efter 💡/🤖-promptar i:
