...
**Ny med LangChain4j?** Läs [Ordlista](docs/GLOSSARY.md) för definitioner av nyckelbegrepp och koncept.

## Innehåll

1. [Quick Start](00-quick-start/README.md) - Kom igång med LangChain4j
2. [Introduction](01-introduction/README.md) - Lär dig grunderna i LangChain4j
...
5. Vänta 5–10 minuter för att miljön ska bli klar
6. Hoppa direkt till [Quick Start](./00-quick-start/README.md) för att komma igång!

> **Föredrar du att klona lokalt?**
>
> Detta repository innehåller över 50 översättningar till olika språk som avsevärt ökar nedladdningsstorleken. För att klona utan översättningar, använd sparse checkout:
> ```bash
...
Efter att du har genomfört modulerna, utforska [Testguiden](docs/TESTING.md) för att se LangChain4j-testkoncept i praktiken.

> **Obs:** Denna utbildning använder både GitHub Models och Azure OpenAI. [Quick Start](00-quick-start/README.md) och [MCP](05-mcp/README.md)-modulerna använder GitHub Models (ingen Azure-prenumeration krävs), medan modulerna 1–4 använder Azure OpenAI GPT-5.


## Lärande med GitHub Copilot

För att snabbt börja koda, öppna det här projektet i en GitHub Codespace eller din lokala IDE med den medföljande devcontainern. Devcontainern som används i den här kursen levereras förkonfigurerad med GitHub Copilot för AI-parprogrammering.
...
- **Java file headers** - Frågor specifika för varje exempel
- **Module READMEs** - Utforskningsfrågor efter kodexemplen
...
Om du kör fast eller har frågor om att skapa AI-appar, gå med i:
