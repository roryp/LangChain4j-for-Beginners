...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T14:36:26+00:00",
...
Börja med [Snabbstart](00-quick-start/README.md)-modulen och gå igenom varje modul för att stegvis bygga dina färdigheter. Du kommer att prova grundläggande exempel för att förstå grunderna innan du går vidare till [Introduktion](01-introduction/README.md)-modulen för en djupare genomgång med GPT-5.
...
> **Notera:** Denna utbildning använder både GitHub Models och Azure OpenAI. [Snabbstart](00-quick-start/README.md) och [MCP](05-mcp/README.md) modulerna använder GitHub Models (ingen Azure-prenumeration krävs), medan modulerna 1-4 använder Azure OpenAI GPT-5.
