...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-15T14:12:17+00:00",
...
Начните с модуля [Быстрый старт](00-quick-start/README.md) и проходите каждый модуль последовательно, чтобы шаг за шагом развивать свои навыки. Вы попробуете базовые примеры, чтобы понять основы, прежде чем перейти к модулю [Введение](01-introduction/README.md) для более глубокого изучения с GPT-5.

<img src="../../translated_images/learning-path.ac2da6720e77c3165960835627cef4c20eb2afb103be73a4f25b6d8fafbd738d.ru.png" alt="Учебный путь" width="800"/>
...
> **Примечание:** В этом обучении используются как модели GitHub, так и Azure OpenAI. Модули [Быстрый старт](00-quick-start/README.md) и [MCP](05-mcp/README.md) используют модели GitHub (подписка Azure не требуется), а модули 1-4 — Azure OpenAI GPT-5.
