...
-->
<img src="../../translated_images/ru/LangChain4j.90e1d693fcc71b50.png" alt="LangChain4j" width="800"/>
...
1. [Быстрый старт](00-quick-start/README.md) - Начинаем работу с LangChain4j
2. [Введение](01-introduction/README.md) - Основы LangChain4j
3. [Создание подсказок](02-prompt-engineering/README.md) - Мастерство эффективного проектирования подсказок
4. [RAG (Retrieval-Augmented Generation)](03-rag/README.md) - Создание интеллектуальных систем на базе знаний
5. [Инструменты](04-tools/README.md) - Интеграция внешних инструментов и простых помощников
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Работа с протоколом Model Context и агентными модулями
---
...
3. Используйте параметры по умолчанию – будет выбран контейнер разработки, созданный для этого курса
...
> **Примечание:** В этом обучении используются как GitHub Models, так и Azure OpenAI. Модуль [Быстрый старт](00-quick-start/README.md) использует GitHub Models (подписка Azure не требуется), а модули 1-5 используют Azure OpenAI.


## Обучение с GitHub Copilot

Чтобы быстро начать кодировать, откройте этот проект в GitHub Codespace или в вашей локальной IDE с предоставленным devcontainer. Devcontainer, используемый в этом курсе, предварительно настроен с GitHub Copilot для AI-совместного программирования.
...
- **README модулях** — Предложения для исследования после примеров кода

**Как использовать:** Откройте любой файл с кодом и задайте Copilot предлагаемые вопросы. Он имеет полный контекст кодовой базы и может объяснять, расширять и предлагать альтернативы.

Хотите узнать больше? Ознакомьтесь с [Copilot для AI-совместного программирования](https://aka.ms/GitHubCopilotAI).
